...
IF ~GlobalGT("VP_Transmuter_Test","GLOBAL",0)
PartyHasItem("dweowarp")
OR(2)
...
Global("VP_Taffic_TraQuest","GLOBAL",0)~ THEN DO ~AddXPObject(Player1,15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Nalia",LastTalkedToBy)
Global("VP_Nalia_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Nalia",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Kachiko",LastTalkedToBy)
Global("VP_Kachi_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Kachiko",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Aerie",LastTalkedToBy)
Global("VP_Aerie_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Aerie",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Taffic",LastTalkedToBy)
Global("VP_Taffic_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Taffic",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Jan",LastTalkedToBy)
Global("VP_Jan_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Jan",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
  IF ~OR(2)
Name("Edwin",LastTalkedToBy)
Global("VP_Edwin_TraQuest","GLOBAL",1)~ THEN DO ~AddXPObject("Edwin",15500)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT31")~ EXIT
END

IF WEIGHT #-1 ~Global("VP_Break_TransTest","GLOBAL",3)
GlobalGT("VP_Transmuter_Test","GLOBAL",0)
!PartyHasItem("dweowarp")
OR(2)
Global("VP_My_Test","LOCALS",1)
...
IF WEIGHT #-2 ~Global("VP_Break_TransTest","GLOBAL",3)
GlobalGT("VP_Transmuter_Test","GLOBAL",0)
PartyHasItem("dweowarp")
OR(2)
Global("VP_My_Test","LOCALS",1)
