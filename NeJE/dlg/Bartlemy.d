...
Global("VP_Lavallins_Plot","GLOBAL",9)~ THEN BEGIN 19
  ...
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",1)~ THEN REPLY ~I found no ring.~ GOTO 38
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",1)~ THEN REPLY ~I am still looking for it.~ GOTO 38
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",2)~ THEN REPLY ~Sorry Bartlemy, I searched Lavallin�s room and I found no ring.~ GOTO 40
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",2)~ THEN REPLY ~I turned Lavallin�s room upside down and inside out. Supposing that your ring was there, it certainly isn�t now.~ GOTO 40
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",2)~ THEN REPLY ~No I haven�t. If that was indeed where you lost it, then someone else has obviously beaten us to it... Lavallin himself maybe?~ GOTO 41
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",3)~ THEN REPLY ~No, sorry... no ring but I did speak to Lavallin again and he told me of Delrysia, and how she disappeared after the accident. Perhaps she took it with her.~ GOTO 45
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",3)~ THEN REPLY ~I turned Lavallin�s room upside down and inside out.  Supposing that your ring was there, it certainly isn�t now. Lavallin did say that another of your friends, Delrysia, also survived the accident. What else haven�t you told me?~ GOTO 45
  IF ~!PartyHasItem("DeLetter")
Global("VP_Delrisia_Letter","GLOBAL",3)~ THEN REPLY ~No I haven�t. If that was indeed where you lost it, then someone else has obviously beaten us to it... uh... Delrysia maybe?~ GOTO 45
END
...
IF ~~ THEN BEGIN 22
  ...
  IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~HROTHJ~ 69
  IF ~OR(2)
!InParty("Hrothgar")
Dead("Hrothgar")~ THEN GOTO 23
END	
...
IF ~~ THEN BEGIN 24
  ...
  IF ~~ THEN REPLY ~I will do this for you, Bartlemy, but be warned, when I return be sure to keep your back against that wall there!~ DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",10)
SetGlobal("VP_Meeting_Delrysia","GLOBAL",1)~ GOTO 36
  IF ~~ THEN REPLY ~I will do this, but no more, Bartlemly! When I return it will be the end of our dealings.~ DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",10)
SetGlobal("VP_Meeting_Delrysia","GLOBAL",1)~ GOTO 36
...
IF WEIGHT #-2 ~Global("VP_Lavallins_Plot","GLOBAL",10)
!Global("VP_Meeting_Delrysia","GLOBAL",2)~ THEN BEGIN 25
...
IF WEIGHT #-3 ~Global("VP_Lavallins_Plot","GLOBAL",10)
Global("VP_Meeting_Delrysia","GLOBAL",2)~ THEN BEGIN 26
...
IF ~~ THEN BEGIN 49
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",12)
GiveItem("TuPotnD1",Player1)~ EXIT
END
...
AddXPObject(Player6,45500)~ EXTERN ~TUPUNG~ 8
END