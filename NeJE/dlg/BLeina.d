...
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 0
 IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ130
END
...
IF ~~ THEN BEGIN PCF2LeinaA
	...
	IF ~!InParty("Taffic")
InParty("Melora")~ THEN EXTERN ~BMELORA~ 55
	IF ~InParty("Taffic")
!InParty("Melora")~ THEN EXTERN ~BTAFFIC~ 6
	IF ~InParty("Taffic")
InParty("Melora")~ THEN EXTERN ~BMELORA~ 48
END
...
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ140
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ 58
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ 129
	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 86
END		
...
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 8
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ 130
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ 59
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ141
	IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ NEJ499
	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 87
END	
...
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 88
	IF ~InParty("Mazzy")
!Dead("Mazzy")~ THEN EXTERN ~BMAZZY~ NEJ2
	IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ NEJ500
	IF ~InParty("Korgan")
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ NEJ1
	IF ~InParty("Taffic")
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 9
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ 60
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ142
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ 131
END
...
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ LeiSpher3
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiSpher1	
END
...
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiSpher1
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher1
END
...
!Dead("Yoshimo")~ THEN EXTERN ~BYOSHIM~ LeiSpher2
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiSpher2
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiSpher3
	IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ LeiSpher2
	IF ~InParty("Korgan")
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ LeiSpher5
	IF ~InParty("Nalia")
!Dead("Nalia")~ THEN EXTERN ~BNALIA~ LeiSpher2
	IF ~InParty("Valygar")
!Dead("Valygar")~ THEN EXTERN ~BVALYGA~ LeiSpher2
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher3	
	IF ~InParty("Taffic")
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiSpher3
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiSpher2		
END	
...
!Dead("Yoshimo")~ THEN EXTERN ~BYOSHIM~ LeiSpher3
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiSpher3
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiSpher4
	IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ LeiSpher3
	IF ~InParty("Korgan")
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ LeiSpher6
	IF ~InParty("Nalia")
!Dead("Nalia")~ THEN EXTERN ~BNALIA~ LeiSpher3
	IF ~InParty("Valygar")
!Dead("Valygar")~ THEN EXTERN ~BVALYGA~ LeiSpher3
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher4	
	IF ~InParty("Taffic")
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiSpher4
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiSpher3		
END
...
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ LeiSpher4
	IF ~InParty("Valygar")
!Dead("Valygar")~ THEN EXTERN ~BVALYGA~ LeiSpher4
	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiSpher2		
END
...
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ LeiThea2
	IF ~InParty("Aerie")
!Dead("Aerie")~ THEN EXTERN ~BAERIE~ LeiThea2
	IF ~InParty("Imoen2")
!Dead("Imoen2")~ THEN EXTERN ~BIMOEN2~ LeiThea2
	IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ LeiThea2
	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiThea2
	IF ~InParty("Taffic")
!Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiThea2
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ LeiThea2	
	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiThea2
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiThea2
END
...
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ RadianQA
 IF ~InParty("Sharteel")
!Dead("Sharteel")~ THEN EXTERN ~BSHART~ RadianQ   	
END
...
!Dead("Viconia")~ THEN EXTERN ~BVICONI~ RadianQ
 IF ~InParty("Sharteel")
!Dead("Sharteel")~ THEN EXTERN ~BSHART~ RadianQ1
 IF ~InParty("Korgan")
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ RadiaQ13 	
END
...
!Dead("Minsc")~ THEN GOTO RadiQ21A
 IF ~InParty("Edwin")
!Dead("Edwin")~ THEN GOTO RadiQ21A
 IF ~InParty("Imoen2")
!Dead("Imoen2")~ THEN GOTO RadiQ21A
 IF ~InParty("Korgan")
!Dead("Korgan")~ THEN GOTO RadiQ21A
 IF ~InParty("Viconia")
!Dead("Viconia")~ THEN GOTO RadiQ21A
 IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN GOTO RadiQ21A
 IF ~InParty("Dar")
!Dead("Dar")~ THEN GOTO RadiQ21A
 IF ~InParty("Melora")
!Dead("Melora")~ THEN GOTO RadiQ21A
 IF ~InParty("Taffic")
!Dead("Taffic")~ THEN GOTO RadiQ21A
 IF ~InParty("Sharteel")
!Dead("Sharteel")~ THEN GOTO RadiQ21A
END
...
!Dead("Korgan")~ THEN EXTERN ~BKORGAN~ LeiRadia
 IF ~InParty("Sharteel")
!Dead("Sharteel")~ THEN EXTERN ~BSHART~ LeiRadia
	IF ~InParty("Imoen2")
!Dead("Imoen2")~ THEN EXTERN ~BIMOEN2~ LeiRadia
	IF ~InParty("Dar")
!Dead("Dar")~ THEN EXTERN ~BDAR~ LeiRadia	
	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiRadia
END
...
//Third Path, AR1000
IF WEIGHT #1 ~GlobalLT("VP_BPC","LOCALS",12)
OR(2)
...
!Dead("Anomen")~ THEN EXTERN ~BANOMEN~ LeiTheat
	IF ~InParty("Aerie")
!Dead("Aerie")~ THEN EXTERN ~BAERIE~ LeiTheat
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiTheat
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiTheat
	IF ~InParty("Kachiko")
!Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiTheaB
	IF ~InParty("Yoshimo")
!Dead("Yoshimo")~ THEN EXTERN ~BYOSHIM~ LeiTheat
END
...
!Dead("Anomen")~ THEN EXTERN ~BANOMEN~ LeiThea3
	IF ~InParty("Aerie")
!Dead("Aerie")~ THEN EXTERN ~BAERIE~ LeiThea3
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiThea3
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiThea3
	IF ~InParty("Kachiko")
!Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiThea3
	IF ~InParty("Yoshimo")
!Dead("Yoshimo")~ THEN EXTERN ~BYOSHIM~ LeiThea3
END
...
!Dead("Anomen")~ THEN EXTERN ~BANOMEN~ LeiThea4
	IF ~InParty("Aerie")
!Dead("Aerie")~ THEN EXTERN ~BAERIE~ LeiThea4
	IF ~InParty("Edwin")
!Dead("Edwin")~ THEN EXTERN ~BEDWIN~ LeiThea4
	IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~BMINSC~ LeiThea4
	IF ~InParty("Kachiko")
!Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiThea4
	IF ~InParty("Yoshimo")
!Dead("Yoshimo")~ THEN EXTERN ~BYOSHIM~ LeiThea4
END
