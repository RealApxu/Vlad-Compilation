...
!Kit(Player1,MAGESCHOOL_DIVINER)~ THEN REPLY ~I have decided to take the tests myself Mordecai.~ GOTO 23
  IF ~OR(2)
!Class(Player1,MAGE_ALL)
Kit(Player1,MAGESCHOOL_DIVINER)~ THEN REPLY ~Perhaps another time Mordecai, I have other matters to attend to at this moment.~ GOTO 20
  IF ~InParty("Nalia")
!Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ329
  IF ~InParty("Aerie")
!Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ231
  IF ~InParty("Kachiko")
...
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P","Nalia")
GiveItem("SCRL7Y","Nalia")~ EXIT
...
IF ~~ THEN BEGIN 20
  ...
  IF ~~ THEN REPLY ~Farewell Mordecai.~ DO ~ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT28")~ EXIT //Quest is lost to PC.
...
IF ~~ THEN BEGIN 22
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P",Player1)
GiveItem("SCRL7Y",Player1)~ EXIT
END //=> Test 1: To silence Ghiala
...
IF ~~ THEN BEGIN 24
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P","Aerie")
GiveItem("SCRL7Y","Aerie")~ EXIT
END //=> Test 1: To silence Ghiala
...
IF ~~ THEN BEGIN 25
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P","Kachiko")
GiveItem("SCRL7Y","Kachiko")~ EXIT
END //=> Test 1: To silence Ghiala
...
IF ~~ THEN BEGIN 27
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P","Edwin")
GiveItem("SCRL7Y","Edwin")~ EXIT
END //=> Test 1: To silence Ghiala

IF ~Global("VP_My_Test","LOCALS",2)
!RealGlobalTimerExpired("VP_Conjurer_Tests","GLOBAL")~ THEN BEGIN 28
...
Dead("Minsc")~ THEN REPLY ~Sure, just say when Mordecai.~ GOTO 32
  IF ~OR(2)
!InParty("Minsc")
Dead("Minsc")~ THEN REPLY ~I guess so.~ GOTO 32
  IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~MINSCJ~ NEJ330
END

IF ~~ THEN BEGIN 32
  SAY ~In your own time <CHARNAME>.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)~ EXIT
...
IF ~!StateCheck("TuConj",STATE_SILENCED)
OR(2)
	Global("VP_My_Test","LOCALS",1)
	Global("VP_My_Test","LOCALS",7)~ THEN BEGIN 35
...
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)
Global("VP_Taffic_ConQuest","GLOBAL",0)~ THEN REPLY ~Please Mordecai, let me attempt the task once more. I will not fail again that you can be sure of.~ GOTO 38
  IF ~Global("VP_Nalia_ConQuest","GLOBAL",0)
Global("VP_Kachi_ConQuest","GLOBAL",0)
Global("VP_Aerie_ConQuest","GLOBAL",0)
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)
Global("VP_Taffic_ConQuest","GLOBAL",0)~ THEN REPLY ~Surely you are not going to fail me on my first attempt?~ GOTO 38
  IF ~Global("VP_Nalia_ConQuest","GLOBAL",0)
Global("VP_Kachi_ConQuest","GLOBAL",0)
Global("VP_Aerie_ConQuest","GLOBAL",0)
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)
Global("VP_Taffic_ConQuest","GLOBAL",0)~ THEN REPLY ~Is that it? I get only one shot at this test of yours?~ GOTO 38
...
Global("VP_Aerie_ConQuest","GLOBAL",0)
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)~ THEN REPLY ~But can I at least not have another attempt at the last part, having past the first?~ GOTO 38
  IF ~Global("VP_Nalia_ConQuest","GLOBAL",0)
Global("VP_Kachi_ConQuest","GLOBAL",0)
Global("VP_Aerie_ConQuest","GLOBAL",0)
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)~ THEN REPLY ~I have proven capable in one task, is that not enough Mordecai?~ GOTO 38
  IF ~Global("VP_Nalia_ConQuest","GLOBAL",0)
Global("VP_Kachi_ConQuest","GLOBAL",0)
Global("VP_Aerie_ConQuest","GLOBAL",0)
Global("VP_Jan_ConQuest","GLOBAL",0)
Global("VP_Edwin_ConQuest","GLOBAL",0)~ THEN REPLY ~Come Mordecai, who will know if you let me attempt the second task again?~ GOTO 38
  IF ~Global("VP_Nalia_ConQuest","GLOBAL",1)~ THEN EXTERN ~NALIAJ~ NEJ330
  IF ~Global("VP_Aerie_ConQuest","GLOBAL",1)~ THEN EXTERN ~AERIEJ~ NEJ232
	IF ~Global("VP_Kachi_ConQuest","GLOBAL",1)~ THEN EXTERN ~KACHIJ~ NEJ68
	IF ~Global("VP_Jan_ConQuest","GLOBAL",1)~ THEN EXTERN ~JANJ~ NEJ198
...
IF ~~ THEN BEGIN taffic1
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Conjurer_Tests","GLOBAL",360)
GiveItem("SCRL7P","Taffic")
GiveItem("SCRL7Y","Taffic")~ EXIT
END //=> Test 1: To silence Ghiala