...
EXTEND_BOTTOM GAELAN 7
  IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~MELORAJ~ 27
END

EXTEND_BOTTOM GAELAN 66
  IF ~InParty("Melora")~ THEN DO ~SetGlobal("Linvail","GLOBAL",1)
GiveItem("MISC4S",[PC])~ EXTERN ~MELORAJ~ 28
END

REPLACE_STATE_TRIGGER GAELAN 19
~!NumTimesTalkedTo(0)
Global("RefusedGaelan","GLOBAL",1)
...
ADD_TRANS_TRIGGER GAELAN 64 ~OR(3)
!InParty("Keldorn")
Dead("Keldorn")
!See("Keldorn")~ DO 0
...
EXTEND_BOTTOM GAELAN 64
  IF ~InParty("Keldorn")
!Dead("Keldorn")
See("Keldorn")~ THEN EXTERN ~KELDORJ~ LT2_new4
END
