...
BEGIN // list of changes, see below for flags
  "ACTION" ~SetGlobal("VP_Imoen_Returns","GLOBAL",1)
...
!Dead("Yoshimo")
InParty("Kachiko")
!Dead("Kachiko")~ THEN DO ~SetGlobal("VP_YoshimoExcuse","GLOBAL",1)~ EXTERN ~KACHIJ~ N32
  IF ~  InParty("Keldorn")
!Dead("Keldorn")
Global("VP_KeldornMatch","GLOBAL",1)~ THEN EXTERN ~KELDORJ~ Imoen0
  	IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN GOTO hrothg1
  	IF ~InParty("Taffic")
!Dead("Taffic")~ THEN EXTERN ~TAFFICJ~ immy1
  	IF ~InParty("Melora")
!Dead("Melora")~ THEN EXTERN ~MELORAJ~ immy1
  	IF ~InParty("Leina")
!Dead("Leina")~ THEN EXTERN ~LEINAJ~ immy1
END
