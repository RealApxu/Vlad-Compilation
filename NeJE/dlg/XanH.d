...
IF WEIGHT #0 ~NumTimesTalkedTo(0)~ THEN BEGIN 0
  ...
  IF ~OR(2)
!InParty("Hrothgar")
Dead("Hrothgar")~ THEN REPLY ~Xan! It's me, <CHARNAME>... don't you recognize me? It is good to see you again. I wondered what had become of you after freeing you from the mines at Nashkel.~ GOTO 1
  ...
  IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN REPLY ~Xan! It's me, <CHARNAME>... don't you recognize me? It is good to see you again. I wondered what had become of you after freeing you from the mines at Nashkel.~ DO ~SetGlobal("VP_Hrothgar_Xan","MYAREA",1)~ EXTERN ~HROTHJ~ 73
END
...
MoveToPointNoInterrupt([1801.455])
Face(1)~ EXIT
  IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN DO ~SetGlobal("VP_Meeting_Xan","GLOBAL",1)~ EXTERN ~JAHEIRAJ~ NEJ549
  IF ~InParty("Hrothgar")
!Dead("Hrothgar")~ THEN DO ~SetGlobal("VP_Meeting_Xan","GLOBAL",1)~ EXTERN ~HROTHJ~ 71
END
...
Face(1)~ EXIT
  IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~JAHEIRAJ~ NEJ549
  IF ~InParty("Minsc")
!Dead("Minsc")~ THEN EXTERN ~MINSCJ~ NEJ263
  IF ~InParty("Hrothgar")
!Dead("Hrothgar")
Global("VP_Hrothgar_Xan","MYAREA",1)~ THEN EXTERN ~HROTHJ~ 71
END
...
!Kit(Player1,MAGESCHOOL_INVOKER)~ THEN REPLY ~I do not have the required spells in my spell book.~ GOTO 28
  IF ~OR(2)
!Class(Player1,MAGE_ALL)
Kit(Player1,MAGESCHOOL_INVOKER)~ THEN REPLY ~I do not have the required spells in my spell book.~ GOTO 30
  ...
  IF ~InParty("Nalia")
!Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ323
  IF ~InParty("Aerie")
!Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ225
  IF ~InParty("Kachiko")
!Dead("Kachiko")~ THEN REPLY ~Kachiko is ready.~ EXTERN ~KACHIJ~ NEJ61
  IF ~InParty("Taffic")
...
GiveItem("SCRL69",Player1)~ EXIT
  IF ~~ THEN REPLY ~Dire Charm.~ DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Xan_Tests","GLOBAL",360)
GiveItem("SCRL1S",Player1)~ EXIT
  IF ~~ THEN REPLY ~Domination.~ DO ~SetGlobal("VP_My_Test","LOCALS",1)
RealSetGlobalTimer("VP_Xan_Tests","GLOBAL",360)
GiveItem("SCRL5N",Player1)~ EXIT
END //=> Test 1: To charm Sharia
...
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~I am.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
...
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT10")~ EXIT
...
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Bring them on, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT10")~ EXIT
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",1)~ THEN REPLY ~Nalia is ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
  SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutN01")~ EXIT
  IF ~Global("VP_Kachi_EnchQuest","GLOBAL",1)~ THEN REPLY ~Kachiko is ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
  SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutK01")~ EXIT
  IF ~Global("VP_Aerie_EnchQuest","GLOBAL",1)~ THEN REPLY ~Aerie is ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
  SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutA01")~ EXIT
  IF ~Global("VP_Jan_EnchQuest","GLOBAL",1)~ THEN REPLY ~Jan is ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
  SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutJ01")~ EXIT
  IF ~Global("VP_Taffic_EnchQuest","GLOBAL",1)~ THEN REPLY ~Taffic is ready when you are, Xan.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",1)
SetGlobal("VP_My_Test","LOCALS",3)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutTf1")~ EXIT
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY #7932 DO ~SetGlobal("VP_My_Test","LOCALS",5)~ GOTO 36
END
...
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~But surely having passed the first test, I can be given another attempt at the second?~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~I have proven capable in one task, is that not enough, Xan?~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Come, Xan, who will know if you let me attempt the second task again?~ GOTO 37
...
IF WEIGHT #5 ~Global("VP_My_Test","LOCALS",1)
!GlobalTimerExpired("VP_Xan_Waiting","GLOBAL")
!RealGlobalTimerExpired("VP_Xan_Tests","GLOBAL")
Alignment("TuEnch",NEUTRAL_GOOD)~ THEN BEGIN 38
...
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Please, Xan, let me attempt the task once more. I will not fail again.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~You cannot possibly fail me after only one attempt, Xan!~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Is that it, Xan? One attempt is hardly fair.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
...
!GlobalTimerExpired("VP_Xan_Waiting","GLOBAL")
Global("VP_Xan_Test2","GLOBAL",1)~ THEN BEGIN 39
...
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutT11")~ EXIT
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",1)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutN02")~ EXIT
  IF ~Global("VP_Aerie_EnchQuest","GLOBAL",1)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutA02")~ EXIT
  IF ~Global("VP_Kachi_EnchQuest","GLOBAL",1)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutK02")~ EXIT
  IF ~Global("VP_Jan_EnchQuest","GLOBAL",1)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutJ02")~ EXIT
  IF ~Global("VP_Taffic_EnchQuest","GLOBAL",1)~ THEN DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)
SetGlobal("VP_My_Test","LOCALS",4)
ClearAllActions()
StartCutSceneMode()
StartCutScene("VPCutTf2")~ EXIT
END

IF WEIGHT #7 ~Global("VP_My_Test","LOCALS",3)
!GlobalTimerExpired("VP_Xan_Waiting","GLOBAL")
Global("VP_Xan_Test2","GLOBAL",0)
Global("VP_Break_CharmTest","GLOBAL",0)~ THEN BEGIN 40
  SAY ~I suppose it is as I expected. How students are expected to learn in a place with such dismal surroundings is beyond me. Both tasks need to be completed in order to pass <CHARNAME>, I am sorry.~
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~But surely having passed the first test, I can be given another attempt at the second?~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~I have proven capable in one task, is that not enough, Xan?~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",0)
Global("VP_Kachi_EnchQuest","GLOBAL",0)
Global("VP_Aerie_EnchQuest","GLOBAL",0)
Global("VP_Jan_EnchQuest","GLOBAL",0)
Global("VP_Taffic_EnchQuest","GLOBAL",0)~ THEN REPLY ~Come, Xan, who will know if you let me attempt the second task again?~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ GOTO 37
  IF ~Global("VP_Nalia_EnchQuest","GLOBAL",1)~ THEN REPLY ~Nalia, that test was designed for students not fully fledged mages! Maybe you should take the time and get some extra education whilst we are here. You may be of more use to me then.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ EXTERN ~NALIAJ~ NEJ324
  IF ~Global("VP_Kachi_EnchQuest","GLOBAL",1)~ THEN REPLY ~Kachiko, that test was designed for students not fully fledged mages! Maybe you should take the time and get some extra education whilst we are here. You may be of more use to me then.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ EXTERN ~KACHIJ~ NEJ62
  IF ~Global("VP_Aerie_EnchQuest","GLOBAL",1)~ THEN REPLY ~Aerie, that test was designed for students not fully fledged mages! Maybe you should take the time and get some extra education whilst we are here. You may be of more use to me then.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ EXTERN ~AERIEJ~ NEJ226
  IF ~Global("VP_Jan_EnchQuest","GLOBAL",1)~ THEN REPLY ~Jan, that test was designed for students not fully fledged mages! Maybe you should take the time and get some extra education whilst we are here. You may be of more use to me then.~ DO ~SetGlobal("VP_Guards_Fix","GLOBAL",0)~ EXTERN ~JANJ~ NEJ194 
...
IF WEIGHT #-1 ~Global("VP_My_Test","LOCALS",3)
!GlobalTimerExpired("VP_Xan_Waiting","GLOBAL")
Global("VP_Xan_Test2","GLOBAL",0)
Global("VP_Break_CharmTest","GLOBAL",1)~ THEN BEGIN 49
