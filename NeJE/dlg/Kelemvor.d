...
PartyHasItem("lightdrp")~ THEN GOTO ext2
		IF ~!PartyHasItem("chocquas")
!PartyHasItem("kidsoil")
!PartyHasItem("darkdrop")
!PartyHasItem("lightdrp")~ THEN GOTO ext7
END
...
TakePartyItem("darkdrop")
TakePartyItem("lightdrp")
...
TakePartyItem("lightdrp")
TakePartyItem("daggerfr")
GiveItemCreate("KelChan",Player1,0,0,0)
ClearAllActions()
StartCutSceneMode()
StartCutScene("KRCut14")~ EXIT
END
