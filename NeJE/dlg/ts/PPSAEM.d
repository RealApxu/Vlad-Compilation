...
IF WEIGHT #5 ~Global("AsylumPlot","GLOBAL",1)
OR(2)
	Global("ThiefGroup","GLOBAL",0)
	Global("ThiefGroup","GLOBAL",1)
OR(2)
	Global("VP_SailTo_Brynnlaw","GLOBAL",0)
	Global("VP_SailTo_Brynnlaw","GLOBAL",3)~ THEN BEGIN 53
...
OR(2)
	See("ppsime")
	Global("Sime_Meet","GLOBAL",0)~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~PPSIME~ 1
  IF ~Global("ThiefGroup","GLOBAL",1)
InParty("Sime")
!Dead("Sime")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~SIMEJ~ 14
  IF ~Global("ThiefGroup","GLOBAL",0)
!Dead("Nalia")
InParty("Nalia")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ EXTERN ~NALIAJ~ 272
  IF ~Global("ThiefGroup","GLOBAL",1)
!Dead("Nalia")
InParty("Nalia")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~NALIAJ~ 272
  IF ~Global("ThiefGroup","GLOBAL",0)
!Dead("Jan")
InParty("Jan")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ EXTERN ~JANJ~ 150
  IF ~Global("ThiefGroup","GLOBAL",1)
!Dead("Jan")
InParty("Jan")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~JANJ~ 150
  IF ~Global("ThiefGroup","GLOBAL",0)
!Dead("Yoshimo")
InParty("Yoshimo")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ EXTERN ~YOSHJ~ 92
  IF ~Global("ThiefGroup","GLOBAL",1)
!Dead("Yoshimo")
InParty("Yoshimo")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~YOSHJ~ 92
  IF ~Global("ThiefGroup","GLOBAL",0)
!Dead("Korgan")
InParty("Korgan")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ EXTERN ~KORGANJ~ 117
  IF ~Global("ThiefGroup","GLOBAL",1)
!Dead("Korgan")
InParty("Korgan")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN ~KORGANJ~ 117
END
...
IF ~~ THEN BEGIN 54
  ...
  OR(2)
See("ppsime")
Global("Sime_Meet","GLOBAL",0)~ THEN EXTERN ~PPSIME~ 2
...
IF ~~ THEN BEGIN 56
  ...
  IF ~Global("ThiefGroup","GLOBAL",1)
!InParty("Sime")
See("ppsime")~ THEN DO ~SetAreaRestFlag(0)
StartCutSceneMode()
StartCutScene("Cut41e")~ EXIT
  IF ~Global("ThiefGroup","GLOBAL",1)
InParty("Sime")~ THEN DO ~SetAreaRestFlag(0)
StartCutSceneMode()
StartCutScene("CUT41EYS")~ EXIT
  IF ~Global("ThiefGroup","GLOBAL",1)
!InParty("Sime")
See("Sime")~ THEN DO ~SetAreaRestFlag(0)
StartCutSceneMode()
StartCutScene("CUT41EYS")~ EXIT
  IF ~Global("ThiefGroup","GLOBAL",0)
InParty("Keldorn")~ THEN DO ~SetAreaRestFlag(0)
SetGlobal("VP_SailTo_Brynnlaw","GLOBAL",4)
SetGlobal("AsylumPlot","GLOBAL",2)
ClearAllActions()
StartCutSceneMode()
StartCutScene("CUT41tke")~ EXIT
  IF ~Global("ThiefGroup","GLOBAL",0)
!InParty("Keldorn")~ THEN DO ~SetAreaRestFlag(0)
SetGlobal("VP_SailTo_Brynnlaw","GLOBAL",4)
SetGlobal("AsylumPlot","GLOBAL",2)
...
IF ~~ THEN BEGIN 59
  ...
  IF ~True()~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",3)
CreateCreature("ppvalen",[790.2031],12)
CreateCreature("ppparis",[599.2212],12)
CreateCreature("ppdel",[542.2326],12)
ReallyForceSpell(Myself,DRYAD_TELEPORT)~ UNSOLVED_JOURNAL #15794 EXIT
  IF ~InParty("Minsc")
!Dead("Minsc")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",3)
CreateCreature("ppvalen",[790.2031],12)
CreateCreature("ppparis",[599.2212],12)
CreateCreature("ppdel",[542.2326],12)
ReallyForceSpell(Myself,DRYAD_TELEPORT)~ UNSOLVED_JOURNAL #15794 EXTERN ~MINSCJ~ 159
  IF ~InParty("Keldorn")
!Dead("Keldorn")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",3)
CreateCreature("ppvalen",[790.2031],12)
CreateCreature("ppparis",[599.2212],12)
CreateCreature("ppdel",[542.2326],12)
ReallyForceSpell(Myself,DRYAD_TELEPORT)~ UNSOLVED_JOURNAL #15794 EXTERN ~KELDORJ~ 191
  IF ~InParty("Mazzy")
!Dead("Mazzy")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",3)
CreateCreature("ppvalen",[790.2031],12)
CreateCreature("ppparis",[599.2212],12)
CreateCreature("ppdel",[542.2326],12)
ReallyForceSpell(Myself,DRYAD_TELEPORT)~ UNSOLVED_JOURNAL #15794 EXTERN ~MAZZYJ~ 168
  IF ~InParty("Anomen")
!Dead("Anomen")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",3)
CreateCreature("ppvalen",[790.2031],12)
CreateCreature("ppparis",[599.2212],12)
CreateCreature("ppdel",[542.2326],12)
ReallyForceSpell(Myself,DRYAD_TELEPORT)~ UNSOLVED_JOURNAL #15794 EXTERN ~ANOMENJ~ 261
END
END
...
OR(2)
	See("ppsime")
	Global("Sime_Meet","GLOBAL",0)~ THEN EXTERN ~PPSIME~ 1
  IF ~Global("ThiefGroup","GLOBAL",1)
InParty("Sime")
!Dead("Sime")~ THEN EXTERN ~SIMEJ~ 14
  IF ~Global("ThiefGroup","GLOBAL",1)
!InParty("Sime")
See("Sime")~ THEN EXTERN ~PPSIME~ 15
  IF ~InParty("Nalia")
!Dead("Nalia")~ THEN EXTERN ~NALIAJ~ 272
  IF ~InParty("Jan")
!Dead("Jan")~ THEN EXTERN ~JANJ~ 150
  IF ~InParty("Yoshimo")
!Dead("Yoshimo")~ THEN EXTERN ~YOSHJ~ 92
  IF ~InParty("Jaheira")
!Dead("Jaheira")~ THEN EXTERN ~JAHEIRAJ~ 453
  IF ~InParty("Viconia")
!Dead("Viconia")~ THEN EXTERN ~VICONIJ~ 124
END
