...
IF ~~ THEN BEGIN 16
  ...
  IF ~OR(2) InParty("Hrothgar") !Global("StartIWD","GLOBAL",0)~ THEN REPLY ~No such heroics this time. I was about to embark on a search for a friend of mine, Imoen, she was taken by Cowled Wizards to some place only the gods know where, when Hrothgar persuaded me to join him on his quest, assuring me that Imoen would be found safe.~ GOTO 19
  IF ~OR(2) InParty("Hrothgar") !Global("StartIWD","GLOBAL",0)~ THEN REPLY ~I had intended to seek out a wizard by the name of Irenicus. A very dear friend of mine, Imoen, and myself have suffered a lot of pain by his hand and I intend to pay him back double, only Hrothgar persuaded me to postpone my search and join him on his quest.~ GOTO 20
  IF ~OR(2) InParty("Hrothgar") !Global("StartIWD","GLOBAL",0)~ THEN REPLY ~No heroics Leina, I simply have a friend to find and a debt of pain to pay back to an insane wizard, but first I agreed to aid Hrothgar in his quest and that is why I am here.~ GOTO 20
  IF ~!InParty("Hrothgar") Global("StartIWD","GLOBAL",0)~ THEN REPLY ~I am intended to seek out a wizard by the name of Irenicus. A very dear friend of mine, Imoen, and myself have suffered a lot of pain by his hand and I intend to pay him back double.~ GOTO 20A
  IF ~!InParty("Hrothgar") Global("StartIWD","GLOBAL",0)~ THEN REPLY ~No heroics Leina, I simply have a friend to find and a debt of pain to pay back to an insane wizard.~ GOTO 20A
END
...
IF ~~ THEN BEGIN 18
  ...
  IF ~OR(2) InParty("Hrothgar") !Global("StartIWD","GLOBAL",0)~ THEN REPLY ~I am here for two reasons Leina. One, I allowed myself to be persuaded by Hrothgar to aid him in his search and when that is done comes two, revenge on an insane wizard who should have known better than to torture a child of Bhaal!~ GOTO 21
  IF ~!InParty("Hrothgar") Global("StartIWD","GLOBAL",0)~ THEN REPLY ~I am here for one reason Leina: to revenge on an insane wizard who should have known better than to torture a child of Bhaal!~ GOTO 21
END
...
(*As she finishes singing, she looks about her, the group has stopped to listen.*)~
  ...
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 0
...
IF WEIGHT #0 ~Global("VP_BPC","LOCALS",11) GlobalLT("VP_MyFatherIsDead","LOCALS",3) GlobalLT("VP_Break_Point","LOCALS",2)~ THEN BEGIN 64
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~What do you want to hear Leina?~ DO ~SetGlobal("VP_BPC","LOCALS",12)~ GOTO N65
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~You want a description, the details of his dying Leina, is that what you are asking me to tell?~ DO ~SetGlobal("VP_BPC","LOCALS",12)~ GOTO N71
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~I have already told you, it was a means to get to you Leina, nothing more.~ DO ~SetGlobal("VP_BPC","LOCALS",12)~ GOTO N72
END
...
IF ~~ THEN BEGIN 76
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~Then believe in the truth, that in his poor sick mind he saw me as an intruder, someone intent on taking away the only thing he had left in this world, his daughter.~ GOTO N77
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~All I can say is look back at the state of his mind, his recent behaviour and then judge what you believe his actions would have been faced with an intruder in his home.~ GOTO N77
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~Only you can decide what to believe and who to trust but you need time to grieve for your father properly before you try to make sense of anything. Stay with the group, give yourself that time.~ GOTO N77
END
...
IF ~~ THEN BEGIN 82
  ...
  IF ~Global("BodhiJob","GLOBAL",0) Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~I only wanted to ask him about you, but I guess my sudden intrusion scared him too well and he would not listen.~ GOTO 76
  IF ~~ THEN REPLY ~Murder was not intended, you must believe me. I simply did not stop to consider what his reaction might be to seeing armed intruders burst into his home. I am sorry, I should have.~ GOTO 76
END
...
IF ~~ THEN BEGIN 102
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Enable_Flirts","LOCALS",1)  RestParty()~ EXIT //first flirt phase
END

IF ~Global("VP_BPC","LOCALS",15) Global("VP_BPC_Buffer1","LOCALS",1)~ THEN BEGIN 103
...
(*Stops quite still*) Listen, do you hear that?~
  IF ~~ THEN REPLY ~What is it Leina, trouble? Curses, and us out in the open like this.~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer1","LOCALS",2)~ GOTO 104
  IF ~~ THEN REPLY ~What... where...?~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer1","LOCALS",2)~ GOTO 104
  IF ~~ THEN REPLY ~I hear only the song of a bird Leina. What do you hear?~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer1","LOCALS",2)~ GOTO 105
END
...
IF ~Global("VP_BPC","LOCALS",15) Global("VP_BPC_Buffer2","LOCALS",1)~ THEN BEGIN 133
  SAY ~I am tired of carrying the grime of the road, can we not find an inn to spend this night?~
  IF ~~ THEN REPLY ~So, I take it you are not enjoying a life on the road Leina?~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer2","LOCALS",2)~ GOTO 134
  IF ~~ THEN REPLY ~What does it matter where we sleep, you always end up walking the floor most of the night anyway Leina?~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer2","LOCALS",2)~ GOTO 135
  IF ~~ THEN REPLY ~And here I am thinking that bards like to look at the stars, compose and sing songs whilst looking to the moon.~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer2","LOCALS",2)~ GOTO 136
  IF ~~ THEN REPLY ~Most of the inns we have frequented have all been rat infested. If I am to sleep with rats I am not paying for the privilege.~ DO ~SetGlobal("VP_BPC","LOCALS",16) SetGlobal("VP_BPC_Buffer2","LOCALS",2)~ GOTO 137
END
...
IF ~Global("VP_BPC","LOCALS",16) Global("VP_BPC_Buffer2","LOCALS",3) Global("VP_Bathe_Talk","LOCALS",1)~ THEN BEGIN 144
...
IF ~Global("VP_BPC","LOCALS",16) Global("VP_BPC_Buffer2","LOCALS",5)~ THEN BEGIN 156
...
IF ~Global("VP_BPC","LOCALS",16) Global("VP_BPC_Buffer2","LOCALS",3) Global("VP_Bathe_Talk","LOCALS",0)~ THEN BEGIN 175
...
IF ~~ THEN BEGIN 176
  ...
  IF ~~ THEN DO ~SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1) RestParty()~ EXIT
END
...
IF ~Global("VP_LoveTalk","LOCALS",2) Gender(Player1,MALE)~ THEN BEGIN 220
...
IF ~Global("VP_LoveTalk","LOCALS",2) Gender(Player1,FEMALE)~ THEN BEGIN 236
  SAY ~(*Softly singing to herself*) No man will my heart, ever embrace... no... that isn't right... My heart has no need to e'er... Drat, That's no good either!~
...
IF ~~ THEN BEGIN 255
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",3) SetGlobal("VP_We_Want_ToDance","LOCALS",1)~ EXIT
END
...
IF ~Global("VP_LoveTalk","LOCALS",5) Gender(Player1,MALE)~ THEN BEGIN PCM2Leina1
...
IF ~~ THEN BEGIN PCM2Leina12a
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",6) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END

IF ~Global("VP_LoveTalk","LOCALS",5) Gender(Player1,FEMALE) Global("VP_We_Want_ToDance","LOCALS",1)~ THEN BEGIN PCF2Leina1a
...
IF ~Global("VP_LoveTalk","LOCALS",5) Gender(Player1,FEMALE) Global("VP_We_Want_ToDance","LOCALS",0)~ THEN BEGIN PCF2Leina1b
  SAY ~(*Leina stands dressed in scarlet skirts and a white bodice. Tied around her trim waist is a bright blue sash*)~
...
IF ~~ THEN BEGIN PCF2LeinaA
  ...
  IF ~InParty("Dar")~ THEN EXTERN ~BDAR~ 127
  IF ~InParty("Hrothgar")~ THEN EXTERN ~BHROTH~ 85
  IF ~InParty("Minsc")~ THEN EXTERN ~BMINSC~ NEJ137
  IF ~!InParty("Taffic") InParty("Melora")~ THEN EXTERN ~BMELORA~ 55
  IF ~InParty("Taffic") !InParty("Melora")~ THEN EXTERN ~BTAFFIC~ 6
  IF ~InParty("Taffic") InParty("Melora")~ THEN EXTERN ~BMELORA~ 48
END
...
IF ~~ THEN BEGIN PCF2Leina13a
  ...
  IF ~InParty("Melora") InParty("Taffic")~ THEN EXTERN ~BMELORA~ 53
  ...
  IF ~InParty("Dar")~ THEN EXTERN ~BDAR~ 126
  IF ~InParty("Hrothgar")~ THEN EXTERN ~BHROTH~ 84
END
...
IF ~Global("VP_LoveTalk","LOCALS",8) Gender(Player1,FEMALE)~ THEN BEGIN PCF3Leina1
  SAY ~I... I will never get used to the sight of so much blood after a battle. It is... we are splattered with the life fluid of others, it covers our clothes, our weapons even our hands. Look at us <CHARNAME>!~
...
IF ~~ THEN BEGIN PCF3Leina12a
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",9) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END

IF ~Global("VP_LoveTalk","LOCALS",8) Gender(Player1,MALE)~ THEN BEGIN PCM3Leina1
...
IF ~Global("VP_LoveTalk","LOCALS",11) Gender(Player1,FEMALE)~ THEN BEGIN PCF4Leina1
  SAY ~Do you believe in ghosts? I mean ghosts of the past, not the undead spirits we battle in crypts and tombs.~
...
IF ~Global("VP_Danicng_Queen","GLOBAL",1) Gender(Player1,MALE)~ THEN BEGIN PCM4Leina1
...
IF ~~ THEN BEGIN PCM4Leina704
  ...
  IF ~InParty("Melora") InParty("Taffic")~ THEN EXTERN ~BMELORA~ 56
  IF ~InParty("Jan")~ THEN EXTERN ~BJAN~ NEJ0
  IF ~InParty("Kachiko")~ THEN EXTERN ~BKACHI~ NEJ0
  IF ~InParty("Mazzy")~ THEN EXTERN ~BMAZZY~ NEJ0
  IF ~InParty("Nalia")~ THEN EXTERN ~BNALIA~ NEJ57
...
IF ~Global("VP_LoveTalk","LOCALS",11) Gender(Player1,MALE)~ THEN BEGIN PCM5Leina1
...
IF ~~ THEN BEGIN PCM5Leina4
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",12) SetGlobal("VP_NoRomantics","LOCALS",1)~ EXIT
END
...
IF ~~ THEN BEGIN PCM5Leina11
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",12) SetGlobal("VP_LookAtStars","LOCALS",1)~ EXIT
END

IF ~Global("VP_LoveTalk","LOCALS",14) Gender(Player1,FEMALE)~ THEN BEGIN PCF6Leina1
  SAY ~As the child of a god, do you think the other gods take any interest in your life <CHARNAME>?~
...
IF ~Global("VP_LookAtStars","LOCALS",2) Gender(Player1,MALE)~ THEN BEGIN PCM6Leina1
...
IF ~~ THEN BEGIN PCM6Leina7
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LookAtStars","LOCALS",3) SetGlobalTimer("VP_LoveTalkN_Timer","GLOBAL",ONE_DAY) RestParty()~ EXIT
END
...
IF ~Global("VP_LoveTalk","LOCALS",14) Gender(Player1,MALE)~ THEN BEGIN PCM7Leina1
...
IF ~~ THEN BEGIN PCM7Leina4
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",15) SetGlobal("VP_Enable_Flirts","LOCALS",4)~ EXIT
END
...
IF ~Global("VP_LoveTalk","LOCALS",17) Gender(Player1,MALE)~ THEN BEGIN PCM8Leina1
...
IF ~~ THEN BEGIN PCM8Leina16
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",18) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END
...
IF WEIGHT #-1 ~Global("VP_Ric_ClericQuest","LOCALS",1)~ THEN BEGIN ClericQuest1
  ...
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ 58
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ 129
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 86
END
...
IF ~~ THEN BEGIN ClericQuest15a
  ...
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 8
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ 130
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ 59
  IF ~InParty("Minsc") !Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ141
  IF ~InParty("Jaheira") !Dead("Jaheira")~ THEN EXTERN ~BJAHEIR~ NEJ499
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 87
END
...
IF ~~ THEN BEGIN ClericQuest19a
  ...
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ 88
  ...
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ 9
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ 60
  IF ~InParty("Minsc") !Dead("Minsc")~ THEN EXTERN ~BMINSC~ NEJ142
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ 131
END
...
IF ~~ THEN BEGIN ClericQuest22a
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Ric_ClericQuest","LOCALS",4) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END
...
IF WEIGHT #-4 ~Global("VP_Ric_DeArnise","LOCALS",1) Global("PCKeepOwner","GLOBAL",1)~ THEN BEGIN DeArnise1
...
IF WEIGHT #-5 ~Global("VP_Ric_DeArnise","LOCALS",1) Global("RoenalControl","GLOBAL",1) InParty("Korgan") !Dead("Korgan")~ THEN BEGIN DeArnise8
...
IF WEIGHT #-6 ~Global("VP_Ric_DeArnise","LOCALS",1) Global("RoenalControl","GLOBAL",1) InParty("Mazzy") !Dead("Mazzy") OR(2)  !InParty("Korgan")  Dead("Korgan")~ THEN BEGIN DeArnise12
...
IF WEIGHT #-7 ~Global("VP_Ric_DeArnise","LOCALS",1) Global("RoenalControl","GLOBAL",1) InParty("Hrothgar") !Dead("Hrothgar") OR(2)  !InParty("Korgan")  Dead("Korgan") OR(2)  !InParty("Mazzy")  Dead("Mazzy")~ THEN BEGIN DeArnise16
...
IF ~~ THEN BEGIN Sphere7
  ...
  IF ~InParty("Korgan") !Dead("Korgan") Gender(Player1,MALE)~ THEN REPLY ~Who really cares? All I'm interested in is gold, ale, power and a warm body to crawl on.~ GOTO Sphere8
  IF ~OR(2) !InParty("Korgan") Dead("Korgan") Gender(Player1,FEMALE)~ THEN REPLY ~Who really cares? All I'm interested in is gold, ale, power and a warm body to crawl on.~ GOTO Sphere9
...
IF ~~ THEN BEGIN Sphere8a
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Ric_Sphere","LOCALS",2) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END
...
IF ~~ THEN BEGIN Sphere15
  ...
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar")~ THEN REPLY ~An Inn?~ GOTO Sphere18
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar")~ THEN REPLY ~A Windmill?~ GOTO Sphere18
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar")~ THEN REPLY ~A Dungeon?~ GOTO Sphere18
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiSpher1
END
...
IF ~~ THEN BEGIN Sphere16
  ...
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~An Inn?~ GOTO Sphere18
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~A Windmill?~ GOTO Sphere18
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~A Dungeon?~ GOTO Sphere18
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiSpher1
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher1
END
...
IF ~~ THEN BEGIN Sphere18
  ...
  IF ~OR(2) !InParty("Yoshimo") Dead("Yoshimo") OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~A gem bag?~ GOTO Sphere19
  IF ~OR(2) !InParty("Yoshimo") Dead("Yoshimo") OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~A flask?~ GOTO Sphere19
  IF ~OR(2) !InParty("Yoshimo") Dead("Yoshimo") OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~A clay jar?~ GOTO Sphere19
  ...
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher3
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiSpher3
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiSpher2
END
...
IF ~~ THEN BEGIN Sphere19
  ...
  IF ~OR(2) !InParty("Yoshimo") Dead("Yoshimo") OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~A box?~ GOTO Sphere20
  ...
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ LeiSpher4
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiSpher4
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiSpher3
END
...
IF ~~ THEN BEGIN Sphere25
  ...
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiSpher2
END
...
IF ~~ THEN BEGIN TheatrQ9
  ...
  IF ~OR(2) !InParty("Imoen2") Dead("Imoen2")~ THEN REPLY ~I swear you lay one finger on me and you'll wish you hadn't.~ GOTO TheatQ11
...
IF ~~ THEN BEGIN TheaQ151
  ...
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~BMELORA~ LeiThea2
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~BTAFFIC~ LeiThea2
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ LeiThea2
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiThea2
...
IF ~~ THEN BEGIN TheatQ19
  ...
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN REPLY ~Just becasue it seems we are always on the road doesn't mean we haven't taken in the traveling shows we have crossed paths with along the way... we do have more important issues to address.~ GOTO TheatQ20
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar")~ THEN REPLY ~Just becasue it seems we are always on the road doesn't mean we haven't taken in the traveling shows we have crossed paths with along the way... we do have more important issues to address.~ GOTO TheaQ201
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN REPLY ~When do we have no time to dally with the fantasies of bards... there are more important issues to address.~ GOTO TheatQ20
  IF ~OR(2) !InParty("Hrothgar") Dead("Hrothgar")~ THEN REPLY ~When do we have no time to dally with the fantasies of bards... there are more important issues to address.~ GOTO TheaQ201
END
...
IF ~~ THEN BEGIN RadianQ2
  ...
  IF ~OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~Yes, a most despicable specimen of his kind I admit. So, what got you so annoyed about  Firkraag?~ GOTO RadianQ8
  IF ~OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~Most dragons are of the evil vile type, so why so steamed up over that one?~ GOTO RadianQ8
  IF ~PartyHasItem("FAMFAIR") OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~(*Laughing heartily*) So my little pet has upset up. I must tell him to be nicer. Now tell me, what is it that he must change so as not to annoy you so much?~ GOTO RadianQ7
  IF ~!PartyHasItem("FAMFAIR") OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~(*Laughing heartily*) So my little pet has upset up. I must tell him to be nicer. Now tell me, what is it that he must change so as not to annoy you so much?~ GOTO RadiaQ7a
...
IF ~~ THEN BEGIN RadiaQ10
  ...
  IF ~InParty("Korgan") !Dead("Korgan") OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~Leina, of course I care whether I'm manipulated into action or not. The dragon's dead for his manipulation. Let it go, already! And lighten up a little bit. Korgan's just funning with you.~ GOTO RadiaQ11
  IF ~OR(2) !InParty("Korgan") Dead("Korgan") OR(2) Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) Global("SPRITE_IS_DEADfirkra04","GLOBAL",1)~ THEN REPLY ~Leina, of course I care whether I'm manipulated into action or not. The dragon's dead for his manipulation. Let it go, already! And lighten up a little bit.~ GOTO RadiaQ11
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("SPRITE_IS_DEADfirkra04","GLOBAL",0) InParty("Korgan") !Dead("Korgan")~ THEN REPLY ~Leina, of course I care whether I'm manipulated into action or not. Let it go, already! And lighten up a little bit. Korgan's just funning with you.~ GOTO RadiaQ11
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("SPRITE_IS_DEADfirkra04","GLOBAL",0) OR(2) !InParty("Korgan") Dead("Korgan")~ THEN REPLY ~Leina, of course I care whether I'm manipulated into action or not. Let it go, already! And lighten up a little bit.~ GOTO RadiaQ11
END
...
IF ~~ THEN BEGIN RadiaQ20
  ...
  IF ~OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic") OR(2) !InParty("Sharteel") Dead("Sharteel")~ THEN REPLY ~You know Leina, you're right we did have a rough go and since Samuel's is your favorite spot let's get on over there.~ GOTO RadiaQ21
  IF ~OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic") OR(2) !InParty("Sharteel") Dead("Sharteel")~ THEN REPLY ~I don't know about Samuel's, the pickings are getting too familiar over there. The ale's great but a little variety does a body good.~ GOTO RadiaQ22
  IF ~OR(2) !InParty("Minsc") Dead("Minsc") OR(2) !InParty("Edwin") Dead("Edwin") OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic") OR(2) !InParty("Sharteel") Dead("Sharteel")~ THEN REPLY ~When we get there I'm gonna ask Samuel to make a special tub to fit my size  better. You know, we must be his best customers so me thinks he shouldn't be charging us rent.~ GOTO RadiaQ23
  IF ~InParty("Minsc") !Dead("Minsc")~ THEN GOTO RadiQ21A
  IF ~InParty("Edwin") !Dead("Edwin")~ THEN GOTO RadiQ21A
  IF ~InParty("Imoen2") !Dead("Imoen2")~ THEN GOTO RadiQ21A
  IF ~InParty("Korgan") !Dead("Korgan")~ THEN GOTO RadiQ21A
  IF ~InParty("Viconia") !Dead("Viconia")~ THEN GOTO RadiQ21A
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN GOTO RadiQ21A
  IF ~InParty("Dar") !Dead("Dar")~ THEN GOTO RadiQ21A
  IF ~InParty("Melora") !Dead("Melora")~ THEN GOTO RadiQ21A
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN GOTO RadiQ21A
  IF ~InParty("Sharteel") !Dead("Sharteel")~ THEN GOTO RadiQ21A
END
...
IF ~~ THEN BEGIN RadiQ21A
  ...
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~BDAR~ LeiRadia
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~BHROTH~ LeiRadia
END
...
//Third Path, AR1000
IF WEIGHT #1 ~GlobalLT("VP_BPC","LOCALS",12) OR(2) Global("VP_Break_Point","LOCALS",2) Global("VP_MyFatherIsDead","LOCALS",3)~ THEN BEGIN N64
  SAY ~<CHARNAME>, I cannot continue further with you until I know the truth of my my father's death.~
  IF ~Global("BodhiJob","GLOBAL",2)~ THEN REPLY ~What do you want to hear Leina?~ DO ~SetGlobal("VP_Break_Point","LOCALS",2)~ GOTO 65
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~What do you want to hear Leina?~ DO ~SetGlobal("VP_Break_Point","LOCALS",2)~ GOTO N65
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~You want a description, the details of his dying Leina, is that what you are asking me to tell?~ DO ~SetGlobal("VP_Break_Point","LOCALS",2)~ GOTO N71
  ...
  IF ~Global("BodhiJob","GLOBAL",0)  Global("VP_Guild_Attacked","GLOBAL",1)~ THEN REPLY ~I have already told you, it was a means to get to you Leina, nothing more.~ DO ~SetGlobal("VP_Break_Point","LOCALS",2)~ GOTO N72
END

/////////////////////////CHAINS//////////////////////

CHAIN
IF ~Global("VP_JahiNoDancing","LOCALS",3)~ THEN BLEINA PCM4aJahi
...
CHAIN
IF ~Global("VP_AerieNoDancing","LOCALS",3)~ THEN BLEINA PCM4aAerie
...
CHAIN
IF ~Global("VP_VickyNoDancing","LOCALS",3)~ THEN BLEINA PCM4aVicky
...
CHAIN
IF ~Global("VP_KorganNoDancing","LOCALS",3)~ THEN BLEINA PCM4aKorgan
...
CHAIN
IF ~Global("VP_BJan","LOCALS",2)~ THEN BLEINA BanterJan
...
CHAIN
IF ~Global("VP_BAnomen","LOCALS",2)~ THEN BLEINA BanterAnomen
...
CHAIN
IF ~Global("VP_BMazzy","LOCALS",2)~ THEN BLEINA BanterMazzy
...
CHAIN
IF ~Global("VP_Leina_HaerDalis","LOCALS",2)~ THEN BLEINA haerdal
...
CHAIN
IF ~Global("VP_Leina_Keldorn","LOCALS",2)~ THEN BLEINA keldorn
...
CHAIN
IF ~Global("VP_BMelora","LOCALS",2) Global("SPRITE_IS_DEADTrebois","LOCALS",0)~ THEN BLEINA melora1
...
CHAIN
IF ~Global("VP_BMelora","LOCALS",2) Global("SPRITE_IS_DEADTrebois","LOCALS",1)~ THEN BLEINA melora1a
...
CHAIN
IF ~Global("VP_BMelora","LOCALS",5)~ THEN BLEINA melora2
...
IF ~~ THEN BEGIN LeiTheat
  ...
  IF ~OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Jan") Dead("Jan") OR(2) !InParty("Keldorn") Dead("Keldorn") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Mazzy") Dead("Mazzy") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~Oh enough with your horse play! Leina always wants a hot bath let's get the jump on her first this time. What say you?~ GOTO LeiThea1
  IF ~OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Jan") Dead("Jan") OR(2) !InParty("Keldorn") Dead("Keldorn") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Mazzy") Dead("Mazzy") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~Sssssh. Now listen Leina always wants a bath after a battle and she hasn't said anything yet so let's do it first.~ GOTO LeiThea1
  IF ~OR(2) !InParty("Imoen2") Dead("Imoen2") OR(2) !InParty("Jaheira") Dead("Jaheira") OR(2) !InParty("Jan") Dead("Jan") OR(2) !InParty("Keldorn") Dead("Keldorn") OR(2) !InParty("Korgan") Dead("Korgan") OR(2) !InParty("Mazzy") Dead("Mazzy") OR(2) !InParty("Nalia") Dead("Nalia") OR(2) !InParty("Valygar") Dead("Valygar") OR(2) !InParty("Viconia") Dead("Viconia") OR(2) !InParty("Hrothgar") Dead("Hrothgar") OR(2) !InParty("Dar") Dead("Dar") OR(2) !InParty("Melora") Dead("Melora") OR(2) !InParty("Taffic") Dead("Taffic")~ THEN REPLY ~Hey now, listen Leina is always the first to want a bath after a stinkin' battle so let's ask her first for a fluffy towel. What say you?~ GOTO LeiThea1
...
IF ~~ THEN BEGIN theatr3b
  ...
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiTheaB
...
IF ~~ THEN BEGIN theatr3c
  ...
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiThea3
...
IF ~~ THEN BEGIN theatr3d
  ...
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN EXTERN ~BKACHI~ LeiThea4
