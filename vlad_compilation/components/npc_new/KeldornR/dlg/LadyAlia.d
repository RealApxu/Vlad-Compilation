...
IF WEIGHT #0 ~NumTimesTalkedTo(0) Global("VP_Kr_TheWar","GLOBAL",8) Global("VP_Talk_To_Keldorn","LOCALS",1)~ THEN BEGIN 0
...
IF ~~ THEN BEGIN 3
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Talk_To_Keldorn","LOCALS",3) SetGlobal("VP_Castle_Banters","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut20")~ EXIT
END
