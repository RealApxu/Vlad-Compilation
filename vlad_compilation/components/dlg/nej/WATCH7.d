...
IF ~RandomNum(5,1)~ THEN BEGIN 0
  ...
  IF ~!Global("VP_Inside_CK","GLOBAL",1)~ THEN EXIT
  IF ~Global("VP_Inside_CK","GLOBAL",1)~ THEN REPLY ~Please, open the gate.~ GOTO 5
END
...
IF ~~ THEN BEGIN 5
  SAY ~Sure.~
  IF ~~ THEN DO ~SetGlobal("VP_Inside_CK","GLOBAL",0) ClearAllActions() StartCutScene("VPCutCK") ~ EXIT
END