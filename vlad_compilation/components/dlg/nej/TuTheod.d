...
IF ~~ THEN BEGIN 6
  ...
  IF ~Class(Player1,MAGE_ALL) !Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I have the spells, Theodoran, but I have not had the opportunity to memorise them.~ GOTO 8
  IF ~OR(2) !Class(Player1,MAGE_ALL) Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I have the spells, Theodoran, but I have not had the opportunity to memorise them.~ GOTO 9
  ...
  IF ~InParty("Nalia") !Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ326
  IF ~InParty("Aerie") !Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ228
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN REPLY ~Kachiko is ready.~ EXTERN ~KACHIJ~ NEJ64
  IF ~InParty("Jan") !Dead("Jan")~ THEN REPLY ~Jan, this calls for your skill and expertise, are you ready?~ EXTERN ~JANJ~ invoker
  IF ~InParty("Edwin") !Dead("Edwin")~ THEN REPLY ~Edwin, I know this is beneath you and I shouldn't really be asking but as there is no other in the group as well versed in magic as you, could you possibly consider dealing with this mage's request for me ... please?~ EXTERN ~EDWINJ~ invoker1
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN REPLY ~Taffic, do you think you can handle this?~ EXTERN ~TAFFICJ~ invoker
END

IF ~~ THEN BEGIN 7
  SAY ~Commendable, <GABBER>!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT13")~ EXIT
END //=> Invoker: Test 1
...
IF ~OR(2) Global("VP_My_Test","LOCALS",2) Global("VP_My_Test","LOCALS",4)~ THEN BEGIN 19
  ...
  IF ~InParty("Nalia") !Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ327
  IF ~InParty("Aerie") !Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ229
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN REPLY ~Kachiko is ready.~ EXTERN ~KACHIJ~ NEJ65
  IF ~InParty("Jan") !Dead("Jan")~ THEN REPLY ~Jan, this calls for your skill and expertise, are you ready?~ EXTERN ~JANJ~ invoker2
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN REPLY ~Taffic, do you think you can handle this?~ EXTERN ~TAFFICJ~ invoker2
  IF ~InParty("Edwin") !Dead("Edwin") Global("VP_My_Test","LOCALS",2)~ THEN REPLY ~Edwin, I know this is beneath you and I shouldn't really be asking but as there is no other in the group as well versed in magic as you, could you possibly consider dealing with this mage's request for me ... please?~ EXTERN ~EDWINJ~ invoker1

END

IF ~~ THEN BEGIN 20
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT13")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT15")~ EXIT
END //=> Invoker: Test 1

IF ~Global("VP_Invoker_Test","GLOBAL",1) OR(2) Global("VP_My_Test","LOCALS",1) Global("VP_My_Test","LOCALS",5)~ THEN BEGIN 21
  ...
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~I certainly did not expect to serve as an exterminator during my time at Halruaa, Theodoran.~ GOTO 22
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~Hardly a task for an Invoker, Theodoran. Still, I suppose using your students as exterminators means you do not have to dirty your own hands.~ GOTO 22
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~So, under the guise of performing tests, Halruaa's students have to clear the vermin, is that not what this was about, Theodoran?~ GOTO 22
...
IF ~~ THEN BEGIN 22
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT14")~ EXIT
END

IF ~!Global("VP_Invoker_Test","GLOBAL",1) OR(2) Global("VP_My_Test","LOCALS",1) Global("VP_My_Test","LOCALS",5)~ THEN BEGIN 23
...
IF ~~ THEN BEGIN 25
  ...
  IF ~~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT17")~ EXIT
END //Invoker: Test 1 is failed

IF ~~ THEN BEGIN 26
  SAY ~Commendable, Nalia!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN06")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN 27
  SAY ~Commendable, Kachiko!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK06")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN 28
  SAY ~Commendable, Aerie!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA06")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN 29
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN06")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN07")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN 30
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK06")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK07")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN 31
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA06")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA07")~ EXIT
END //=> Invoker: Test 1
...
IF ~~ THEN BEGIN 32
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN08")~ EXIT
END
...
IF ~~ THEN BEGIN 33
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK08")~ EXIT
END
...
IF ~~ THEN BEGIN 34
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA08")~ EXIT
END

IF WEIGHT #-1 ~!Global("VP_Invoker_Test","GLOBAL",1) Global("VP_Break_AlterTest","GLOBAL",1) OR(2) Global("VP_My_Test","LOCALS",1) Global("VP_My_Test","LOCALS",5)~ THEN BEGIN 35
...
IF WEIGHT #-2 ~Global("VP_Invoker_Test","GLOBAL",1) Global("VP_Break_AlterTest","GLOBAL",1) OR(2) Global("VP_My_Test","LOCALS",1) Global("VP_My_Test","LOCALS",5)~ THEN BEGIN 37
  SAY ~Well, that did not go very well did it? In fact that was an abysmal attempt. You're bleeding, and I had no choice but to interrupt the test and bring you back here.~
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~I certainly did not expect to serve as an exterminator during my time at Halruaa, Theodoran.~ GOTO 22
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~Hardly a task for an Invoker, Theodoran. Still, I suppose using your students as exterminators means you do not have to dirty your own hands.~ GOTO 22
  IF ~Global("VP_Nalia_InvQuest","GLOBAL",0) Global("VP_Kachi_InvQuest","GLOBAL",0) Global("VP_Aerie_InvQuest","GLOBAL",0) Global("VP_Taffic_InvQuest","GLOBAL",0) Global("VP_Edwin_InvQuest","GLOBAL",0) Global("VP_Jan_InvQuest","GLOBAL",0)~ THEN REPLY ~So, under the guise of performing tests, Halruaa's students have to clear the vermin, is that not what this was about, Theodoran?~ GOTO 22
...
IF ~~ THEN BEGIN taftest1
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutTf6")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN taftest2
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutTf6")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutTf7")~ EXIT
END //=> Invoker: Test 1
...
IF ~~ THEN BEGIN tafftest
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutTf8")~ EXIT
END

IF ~~ THEN BEGIN edwtest1
  SAY ~Commendable, Edwin!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutE06")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutE07")~ EXIT
END //=> Invoker: Test 1
...
IF ~~ THEN BEGIN edwdone
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutE08")~ EXIT
END
...
IF ~~ THEN BEGIN failtest
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",4) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT16")~ EXIT
END

IF ~~ THEN BEGIN jantest1
  SAY ~Commendable, Jan!~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ06")~ EXIT
END //=> Invoker: Test 1

IF ~~ THEN BEGIN jantest2
  SAY ~Then you may proceed.~
  IF ~Global("VP_My_Test","LOCALS",2)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ06")~ EXIT
  IF ~Global("VP_My_Test","LOCALS",4)~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",5) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ07")~ EXIT
END //=> Invoker: Test 1
...
IF ~~ THEN BEGIN jandone
  ...
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",3) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ08")~ EXIT
END
...
IF ~~ THEN BEGIN npcstest
  ...
  IF ~~ THEN REPLY ~I have no time for your little tests, Theodoran, I will be leaving.~ GOTO 12
  IF ~~ THEN REPLY ~Perhaps another time, Theodoran, I have other matters to attend to at this moment in time.~ GOTO 12
  IF ~Class(Player1,MAGE_ALL) !Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I am ready to pass your exams and I have the spells, but I have not had the opportunity to memorise them.~ GOTO 8
  IF ~OR(2) !Class(Player1,MAGE_ALL) Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I am ready to pass your exams and I have the spells, but I have not had the opportunity to memorise them.~ GOTO 9
  IF ~Class(Player1,MAGE_ALL) !Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I do not have the required spells in my spell book.~ GOTO 10
  IF ~OR(2) !Class(Player1,MAGE_ALL) Kit(Player1,MAGESCHOOL_ENCHANTER)~ THEN REPLY ~I do not have the required spells in my spell book.~ GOTO 11
  IF ~InParty("Nalia") !Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ326
  IF ~InParty("Aerie") !Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ228
