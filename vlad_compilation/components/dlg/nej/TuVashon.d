...
IF ~NumTimesTalkedTo(0) !Global("VP_Illusion_Quest","GLOBAL",10)~ THEN BEGIN 0
...
IF ~~ THEN BEGIN 9
  ...
  IF ~InParty("Nalia") !Dead("Nalia")~ THEN REPLY ~Nalia is going to test her abilities.~ EXTERN ~NALIAJ~ NEJ328
  IF ~InParty("Aerie") !Dead("Aerie")~ THEN REPLY ~Aerie is prepared to be assessed.~ EXTERN ~AERIEJ~ NEJ230
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN REPLY ~Kachiko is ready.~ EXTERN ~KACHIJ~ NEJ66
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN REPLY ~Taffic, I believe this is where you should come into your own, you being an illusionist.~ EXTERN ~TAFFICJ~ vashtest
  IF ~InParty("Jan") !Dead("Jan")~ THEN REPLY ~Jan, as an illusionist and with your thieves skills, this should be walk over for you, a chance for your name to be added to the already famous Jansen's exploits.~ EXTERN ~JANJ~ vashtest
  IF ~InParty("Edwin") !Dead("Edwin")~ THEN REPLY ~Edwin, I know this isn't really a task for a conjurer but I believe you are a versatile enough mage to handle anything that comes your way. With your virtuosity in magical arts those prizes are as good as ours. What do you say Edwin, could you possibly see your way past the shenanigans of all this and humour the mage by passing his test, please?~ EXTERN ~EDWINJ~ vashtest
END

IF ~~ THEN BEGIN 10
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT24")~ EXIT
...
IF ~~ THEN BEGIN 17
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN09")~ EXIT
END //Illusionist: Test 1 starts

IF ~~ THEN BEGIN 18
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK09")~ EXIT
END //Illusionist: Test 1 starts

IF ~~ THEN BEGIN 19
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA09")~ EXIT
END //Illusionist: Test 1 starts
...
IF ~~ THEN BEGIN 23
  ...
  IF ~~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT25")~ EXIT
...
IF ~~ THEN BEGIN 24
  ...
  IF ~~ THEN REPLY ~Farewell Vashon.~ DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT25")~ EXIT //Quest is lost to PC.
...
IF ~Global("VP_My_Test","LOCALS",1) Global("VP_Illusion_Quest","GLOBAL",1) !PartyHasItem("shadbfak")~ THEN BEGIN 26
...
IF ~Global("VP_My_Test","LOCALS",1) Global("VP_Illusion_Quest","GLOBAL",1) PartyHasItem("shadbfak")~ THEN BEGIN 27
...
IF ~~ THEN BEGIN 29
  ...
  IF ~Global("VP_Nalia_IllQuest","GLOBAL",0) Global("VP_Kachi_IllQuest","GLOBAL",0) Global("VP_Aerie_IllQuest","GLOBAL",0) Global("VP_Taffic_IllQuest","GLOBAL",0) Global("VP_Jan_IllQuest","GLOBAL",0) Global("VP_Edwin_IllQuest","GLOBAL",0)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT26")~ EXIT
  IF ~OR(2) Name("Nalia",LastTalkedToBy) Global("VP_Nalia_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutN10")~ EXIT
  IF ~OR(2) Name("Kachiko",LastTalkedToBy) Global("VP_Kachi_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutK10")~ EXIT
  IF ~OR(2) Name("Aerie",LastTalkedToBy) Global("VP_Aerie_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutA10")~ EXIT
  IF ~OR(2) Name("Taffic",LastTalkedToBy) Global("VP_Taffic_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCuTf10")~ EXIT
  IF ~OR(2) Name("Jan",LastTalkedToBy) Global("VP_Jan_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ10")~ EXIT
  IF ~OR(2) Name("Edwin",LastTalkedToBy) Global("VP_Edwin_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutE10")~ EXIT
END

IF ~Global("VP_My_Test","LOCALS",1) Global("VP_MyTest_byNPCfix","GLOBAL",0) OR(3) Global("VP_Illusion_Quest","GLOBAL",3) Global("VP_Illusion_Quest","GLOBAL",6) Global("VP_Illusion_Quest","GLOBAL",7)~ THEN BEGIN 30
  SAY ~I am sorry <GABBER>, I had thought you are capable of this task and I cannot pass you unless you complete the task.~
  IF ~Global("VP_Nalia_IllQuest","GLOBAL",0) Global("VP_Kachi_IllQuest","GLOBAL",0) Global("VP_Aerie_IllQuest","GLOBAL",0) Global("VP_Taffic_IllQuest","GLOBAL",0) Global("VP_Jan_IllQuest","GLOBAL",0) Global("VP_Edwin_IllQuest","GLOBAL",0)~ THEN REPLY ~Please Vashon, let me try at least once more?~ GOTO 31
  IF ~Global("VP_Nalia_IllQuest","GLOBAL",0) Global("VP_Kachi_IllQuest","GLOBAL",0) Global("VP_Aerie_IllQuest","GLOBAL",0) Global("VP_Taffic_IllQuest","GLOBAL",0) Global("VP_Jan_IllQuest","GLOBAL",0) Global("VP_Edwin_IllQuest","GLOBAL",0)~ THEN REPLY ~Surely you cannot possibly fail me after only one attempt Vashon!~ GOTO 31
  IF ~Global("VP_Nalia_IllQuest","GLOBAL",0) Global("VP_Kachi_IllQuest","GLOBAL",0) Global("VP_Aerie_IllQuest","GLOBAL",0) Global("VP_Taffic_IllQuest","GLOBAL",0) Global("VP_Jan_IllQuest","GLOBAL",0) Global("VP_Edwin_IllQuest","GLOBAL",0)~ THEN REPLY ~Now hold on a minute, one attempt hardly seems fair. How about letting me try again.~ GOTO 31
  IF ~OR(2) Name("Nalia",LastTalkedToBy) Global("VP_Nalia_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
  IF ~OR(2) Name("Kachiko",LastTalkedToBy) Global("VP_Kachi_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
  IF ~OR(2) Name("Aerie",LastTalkedToBy) Global("VP_Aerie_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
  IF ~OR(2) Name("Taffic",LastTalkedToBy) Global("VP_Taffic_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
  IF ~OR(2) Name("Jan",LastTalkedToBy) Global("VP_Jan_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
  IF ~OR(2) Name("Edwin",LastTalkedToBy) Global("VP_Edwin_IllQuest","GLOBAL",1)~ THEN DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT40")~ EXIT
END
...
IF ~~ THEN BEGIN 31
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Illusion_Quest","GLOBAL",8) TakePartyItem("shadbfak") ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT27")~ EXIT
END

IF ~Global("VP_My_Test","LOCALS",1) OR(2) Global("VP_Illusion_Quest","GLOBAL",4) Global("VP_Illusion_Quest","GLOBAL",5)~ THEN BEGIN 32
...
IF ~NumTimesTalkedTo(0) Global("VP_Illusion_Quest","GLOBAL",10)~ THEN BEGIN 34
...
IF ~~ THEN BEGIN taffic
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutTf9")~ EXIT
END //Illusionist: Test 1 starts

IF ~~ THEN BEGIN janjan
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutJ09")~ EXIT
END //Illusionist: Test 1 starts

IF ~~ THEN BEGIN edwin
  SAY ~Ah, a student well versed in the art of illusion, commendable! You may begin your search for my scroll.~
  IF ~~ THEN DO ~SetGlobal("VP_My_Test","LOCALS",1) SetGlobal("VP_Illusion_Quest","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutE09")~ EXIT
END //Illusionist: Test 1 starts

IF ~Global("VP_My_Test","LOCALS",1) Global("VP_MyTest_byNPCfix","GLOBAL",1) OR(3) Global("VP_Illusion_Quest","GLOBAL",3) Global("VP_Illusion_Quest","GLOBAL",6) Global("VP_Illusion_Quest","GLOBAL",7)~ THEN BEGIN newstate
...
IF ~~ THEN BEGIN npcfail
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Illusion_Quest","GLOBAL",8) TakePartyItem("shadbfak") ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT41")~ EXIT
END