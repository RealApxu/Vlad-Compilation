...
IF WEIGHT #-99 ~Global("VP_Kr_ViccyWarTalk","GLOBAL",3) Global("VP_Kr_TheWar","GLOBAL",4)~ THEN BEGIN GotoWar0
...
IF ~~ THEN BEGIN GotoWar2
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Kr_TheWar","GLOBAL",5) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut06")~ JOURNAL ~Thus, I was mobilized, along with the rest of my party. I wish I knew why I am being drawn into this damned war and what awaits me?~ EXIT
END

IF WEIGHT #-98 ~Global("VP_Kr_ViccyWarTalk","GLOBAL",4) Global("VP_Kr_TheWar","GLOBAL",4)~ THEN BEGIN GotoWar3
