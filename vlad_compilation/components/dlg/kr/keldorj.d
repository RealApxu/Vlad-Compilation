...
IF ~~ THEN BEGIN LT2_st1
  ...
  IF ~Global("VP_Guild_Attacked","GLOBAL",0) Global("WorkingForAran","GLOBAL",0) Global("WorkingForBodhi","GLOBAL",0)~ THEN REPLY ~Really I haven't got a clue. All I know is that I need to raise enough gold to pay for Imoen's rescue.~ GOTO LT2_st41
  ...
  IF ~Global("VP_Guild_Attacked","GLOBAL",0) Global("WorkingForAran","GLOBAL",0) Global("WorkingForBodhi","GLOBAL",0)~ THEN REPLY ~Finding opportunities to earn some gold mostly. I was promised some help in finding Imoen, but help does not come free.~ GOTO LT2_st41
...
IF ~~ THEN BEGIN LT2_st3
  ...
  IF ~Global("VP_Guild_Attacked","GLOBAL",0) Global("WorkingForAran","GLOBAL",0) Global("WorkingForBodhi","GLOBAL",0)~ THEN REPLY ~Really I haven't got a clue. All I know is that I need to raise enough gold to pay for Imoen's rescue.~ GOTO LT2_st42
  IF ~!Global("VP_Guild_Attacked","GLOBAL",0)~ THEN REPLY ~Really I haven't got a clue. All I know is that I was requested to raise a hefty amount of gold to pay for Imoen's rescue, but the contact is dead now.~ GOTO LT2_st61
  IF ~Global("VP_Guild_Attacked","GLOBAL",0) Global("WorkingForAran","GLOBAL",0) Global("WorkingForBodhi","GLOBAL",0)~ THEN REPLY ~Finding opportunities to earn some gold mostly. I was promised some help in finding Imoen, but help does not come free.~ GOTO LT2_st42
  IF ~OR(2) Global("WorkingForAran","GLOBAL",1) Global("WorkingForBodhi","GLOBAL",1)~ THEN REPLY ~We must find Imoen, of course. In the meantime, I hired a group of people who promised to help me, but not only that they took fifteen thousands gold from me, I still have to perform a lot of errands for them before for their promise to find my friend!~ GOTO LT2_new1
...
IF ~~ THEN BEGIN LT10a_st1
  ...
  IF ~~ THEN DO ~SetGlobal("VP_KrRomanceActive","GLOBAL",3) ChangeAIScript("",DEFAULT) SetLeavePartyDialogueFile() LeaveParty() EscapeArea()~ JOURNAL ~It was a foolish decision to insist on the lawful resolution of the conflict between sir Keldorn and his wife. Now he's left me... For good.~ EXIT
END
...
IF ~~ THEN BEGIN AV#KR906
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Kr_Funneral","GLOBAL",1) SetGlobal("KeldornFamilyGone","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut01")~ EXIT
END
...
IF ~~ THEN BEGIN AV#KR905
  ...
  IF ~~ THEN DO ~SetGlobal("VP_KrRomanceActive","GLOBAL",3) SetGlobal("VP_Kr_Funneral","GLOBAL",1) SetGlobal("KeldornFamilyGone","GLOBAL",1) ActionOverride("av#mess",EscapeArea()) ChangeAIScript("",DEFAULT) SetLeavePartyDialogueFile() LeaveParty() EscapeArea()~ EXIT
END
...
IF ~~ THEN BEGIN MariTk21
  ...
  IF ~~ THEN DO ~ActionOverride("Maria",EscapeArea()) StartCutSceneMode() StartCutScene("KRCut02")~ EXIT
END
...
IF WEIGHT #-101 ~Global("VP_Kr_Funneral","GLOBAL",9) Global("VP_Talk_Bylanna","GLOBAL",1)~ THEN BEGIN Bylanna1
...
//LT18
IF WEIGHT #-102 ~Global("VP_Kr_Funneral","GLOBAL",11) Global("VP_Kr_Quest","LOCALS",1)~ THEN BEGIN QT_st0
...
IF ~~ THEN BEGIN QT_st7
  ...
  IF ~~ THEN DO ~SetGlobal("VP_KrRomanceActive","GLOBAL",3) LeaveParty() EscapeArea()~ EXIT
END
...
IF ~~ THEN BEGIN Ring_st1_B
  ...
  IF ~~ THEN DO ~GiveItemCreate("kring111",Player1,0,0,0) SetGlobal("VP_Kr_Quest","LOCALS",4) SetGlobalTimer("VP_KrRomance_GTime","GLOBAL",ONE_DAY)~ JOURNAL ~We found Leona's ring. Keldorn insisted that I should have it. I wanted so much to give him a hug and cheer him up, I just do not know how I managed to contain myself.~ EXIT
END
...
IF ~~ THEN BEGIN Ring_st3
  ...
  IF ~~ THEN DO ~GiveItemCreate("kring111",Player1,0,0,0) SetGlobal("VP_Kr_Quest","LOCALS",4) SetGlobal("VP_AnomenJealous","GLOBAL",2) SetGlobalTimer("VP_KrRomance_GTime","GLOBAL",ONE_DAY)~ JOURNAL ~We found Leona's ring. Keldorn insisted that I should have it. I wanted so much to give him a hug and cheer him up, I just do not know how I managed to contain myself.~ EXIT
END
...
IF ~~ THEN BEGIN Rest0_C
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Kr_CyricPlot","GLOBAL",12) SetGlobal("VP_LoveTalk","LOCALS",19) ClearAllActions() StartCutSceneMode() Wait(4) RestParty() EndCutSceneMode()~ EXIT
END
...
IF WEIGHT #-7 ~Global("VP_LoveTalk","LOCALS",20)~ THEN BEGIN morning
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",22) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut18")~ EXIT  //the value of 21 is skipped to follow the original numbering
END
...
IF ~~ THEN BEGIN LT24_st5
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LoveTalk","LOCALS",25) ClearAllActions() StartCutSceneMode() Wait(4) RestParty() EndCutSceneMode()~ EXIT
END
...
IF ~Global("ThiefGroup","GLOBAL",0) Global("AsylumPlot","GLOBAL",2) Global("VP_SailTo_Brynnlaw","GLOBAL",4) Global("VP_SaemonSuspected","LOCALS",0)~ THEN BEGIN Brynn0
  ...
  IF ~~ THEN REPLY #43929 /* ~He has delivered us as promised. There are more important things to worry about.~ */ DO ~SetGlobal("VP_SaemonSuspected","LOCALS",1) SetGlobal("SaemNoBodhi","GLOBAL",1)~ GOTO Brynn1
  IF ~~ THEN REPLY #43930 /* ~Kill him if you wish. I don't care either way.~ */ DO ~SetGlobal("VP_SaemonSuspected","LOCALS",1) SetGlobal("SaemNoBodhi","GLOBAL",1)~ GOTO Brynn2
  IF ~~ THEN REPLY #43931 /* ~He seems amiable enough to me. Come, you'll feel better once off the ship.~ */ DO ~SetGlobal("VP_SaemonSuspected","LOCALS",1) SetGlobal("SaemNoBodhi","GLOBAL",1)~ GOTO Brynn1
END
