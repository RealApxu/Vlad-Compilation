...
!Dead("kaypala")
Global("VP_Anarg_Is_Good","GLOBAL",0)
OR(2)
...
~OR(2)
Dead("kaypala")
Global("VP_Anarg_Is_Good","GLOBAL",1)
PartyHasItem("Misc6i")
ReputationGT([PC],9)
Global("Kayl1Done","GLOBAL",0)~
...
IF ~Global("VP_Anarg_Is_Good","GLOBAL",1)~ THEN DO ~SetGlobal("Kayl1Done","GLOBAL",1)
EraseJournalEntry(34244)
EraseJournalEntry(34245)
EraseJournalEntry(34246)
ReputationInc(1)
TakePartyItem("misc6i")
GiveItemCreate("brac20",LastTalkedToBy,1,0,0)~ SOLVED_JOURNAL ~Seek out and investigate the Fallen Paladins.
