...
OR(2)
!PartyHasItem("key20")
Global("VP_Mask_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("helm05")
Global("VP_Mask_Is_Done","GLOBAL",1)
OR(2)
...
OR(2)
!PartyHasItem("sw2h10")
Global("VP_Carsomyr_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("sw2h14")
Global("VP_Carsomyr_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("simace1")
Global("VP_Mace_Is_Done","GLOBAL",1)
OR(2)
...
Global("VP_Mace_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("rithtel")
Global("VP_Mace_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("robearm")
Global("VP_Robe_Is_Done","GLOBAL",1)
OR(2)
...
Global("VP_Staff_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("staffpow")
Global("VP_Staff_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("bowmess")
Global("VP_Bow_Is_Done","GLOBAL",1)
OR(2)
...
OR(2)
!PartyHasItem("xbow15")
Global("VP_XBow_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("daisy")
Global("VP_XBow_Is_Done","GLOBAL",1)
OR(2)
...
OR(2)
!PartyHasItem("sw1h24")
Global("VP_FlameSw_Is_Done","GLOBAL",1)
OR(2)
...
OR(2)
!PartyHasItem("dagseb")
Global("VP_Dagger_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("misc75")
Global("VP_Dagger_Is_Done","GLOBAL",1)
OR(2)
...
Global("VP_Plate_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("leat14")
Global("VP_Plate_Is_Done","GLOBAL",1)
OR(2)
...
OR(2)
!PartyHasItem("chan11")
Global("VP_Chain_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("chan15")
Global("VP_Chain_Is_Done","GLOBAL",1)
OR(2)
...
Global("VP_Ring_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("ring35")
Global("VP_Ring_Is_Done","GLOBAL",1)
OR(2)
!PartyHasItem("ring36")
Global("VP_Ring_Is_Done","GLOBAL",1)~ DO 0
...
OR(2)
PartyHasItem("sw2h10")
PartyHasItem("sw2h14")~ THEN GOTO IU30
END
...
PartyHasItem("amulbar")
PartyHasItem("tuamulb")
PartyHasItem("leat23")~ THEN GOTO IU0
END
...
PartyHasItem("bowmess")
PartyHasItem("bowhamm")
PartyHasItem("bow10")~ THEN GOTO IU60
END
...
PartyHasItem("ulswd3a")
PartyHasItem("zzc8hb")
PartyHasItem("zzg7ts")~ THEN GOTO IU80
END
...
PartyHasItem("dagseb")
PartyHasItem("misc75")
PartyHasItem("udagg5a")~ THEN GOTO IU90
END
...
BEGIN 19 END // state number
BEGIN 6 END // transition number
BEGIN
  "TRIGGER" ~False()~
END
...
OR(2)
!PartyHasItem("ring36")
Global("VP_Ring_Is_Done","GLOBAL",1)~ THEN GOTO 52
END
...
//Block the transition
ALTER_TRANS WSMITH01
BEGIN 23 END // state number
BEGIN 5 END // transition number
BEGIN
  "TRIGGER" ~False()~
END

//1. Enhanced King Strohm Mask
EXTEND_BOTTOM WSMITH01 23
...
//Block the transition
ALTER_TRANS WSMITH01
BEGIN 33 END // state number
BEGIN 4 END // transition number
BEGIN
  "TRIGGER" ~False()~
END

//1. Enhanced King Strohm Mask
EXTEND_BOTTOM WSMITH01 33
...
IF ~~ THEN BEGIN IU00
  SAY #59749 /* ~I'll keep looking, here, me friend.  Hmmmn...~ */
  	IF ~!Global("VP_Mask_Is_Done","GLOBAL",1)
OR(3)
PartyHasItem("key20")
PartyHasItem("helm05")
PartyHasItem("helm19")~ THEN GOTO IU10
...
IF ~~ THEN BEGIN IU117
  	...
  	IF ~!Global("VP_Carsomyr_Is_Done","GLOBAL",1)
OR(2)
PartyHasItem("sw2h10")
PartyHasItem("sw2h14")~ THEN GOTO IU30
	IF ~OR(2)
...
IF ~~ THEN BEGIN IU37 //85
  ...
  IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",13)~ GOTO IU38
...
IF ~~ THEN BEGIN IU38 //86
  ...
  IF ~PartyGoldGT(19999)~ THEN REPLY #59785 /* ~That sounds fine.  Let's do it.~ */ DO ~TakePartyGold(20000)
DestroyGold(20000)~ GOTO 56
  IF ~PartyGoldLT(25000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU39
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU39
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END

IF ~~ THEN BEGIN IU39
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
	IF ~!Global("VP_Mace_Is_Done","GLOBAL",1)
OR(4)
PartyHasItem("simace1")
PartyHasItem("hammcomm")
PartyHasItem("rithore")
...
IF ~~ THEN BEGIN IU49
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_Robe_Is_Done","GLOBAL",1)
OR(4)
PartyHasItem("robearm")
PartyHasItem("amulbar")
PartyHasItem("tuamulb")
...
IF ~~ THEN BEGIN IU015
  ...
  IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",10)~ GOTO IU016
...
IF ~~ THEN BEGIN IU016
  ...
  IF ~PartyGoldGT(9999)~ THEN REPLY #59785 /* ~That sounds fine.  Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000)~ GOTO 56
  IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU017
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU017
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END

IF ~~ THEN BEGIN IU017
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_Staff_Is_Done","GLOBAL",1)
OR(2)
PartyHasItem("staffbes")
PartyHasItem("staffpow")~ THEN GOTO IU50
  	IF ~OR(2)
...
IF ~~ THEN BEGIN IU59
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_Bow_Is_Done","GLOBAL",1)
OR(3)
PartyHasItem("bowmess")
PartyHasItem("bowhamm")
PartyHasItem("bow10")~ THEN GOTO IU60
...
IF ~~ THEN BEGIN IU67
  ...
  IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",12)~ GOTO IU68
...
IF ~~ THEN BEGIN IU68
  ...
  IF ~PartyGoldGT(9999)~ THEN REPLY #59785 /* ~That sounds fine.  Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000)~ GOTO 56
  IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU69
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU69
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END

IF ~~ THEN BEGIN IU69
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_XBow_Is_Done","GLOBAL",1)
OR(5)
PartyHasItem("xbow15")
PartyHasItem("daisy")
PartyHasItem("clck24")
...
IF ~~ THEN BEGIN IU720
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_FlameSw_Is_Done","GLOBAL",1)
OR(4)
PartyHasItem("sw1h24")
PartyHasItem("ulswd3a")
PartyHasItem("zzc8hb")
...
IF ~~ THEN BEGIN IU815
  ...
  IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",18)~ GOTO IU816
...
DestroyGold(25000)~ GOTO 56
  IF ~PartyGoldLT(25000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU817
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU817
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END

IF ~~ THEN BEGIN IU817
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_Dagger_Is_Done","GLOBAL",1)
OR(3)
PartyHasItem("dagseb")
PartyHasItem("misc75")
PartyHasItem("udagg5a")~ THEN GOTO IU90
...
IF ~~ THEN BEGIN IU97
  ...
  IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",19)~ GOTO IU98
...
IF ~~ THEN BEGIN IU98
  ...
  IF ~PartyGoldGT(9999)~ THEN REPLY #59785 /* ~That sounds fine.  Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000)~ GOTO 56
  IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU99
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO IU99
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END

IF ~~ THEN BEGIN IU99
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
	IF ~!Global("VP_Plate_Is_Done","GLOBAL",1)
OR(3)
PartyHasItem("scalesel")
PartyHasItem("leat14")
PartyHasItem("clck06")~ THEN GOTO IU100
...
IF ~~ THEN BEGIN IU1009
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
	IF ~!Global("VP_Chain_Is_Done","GLOBAL",1)
OR(4)
PartyHasItem("chan11")
PartyHasItem("chan15")
PartyHasItem("boot01")
...
IF ~~ THEN BEGIN IU2017
  	SAY #59742 /* ~Well, what else does ye have in yer packs, then?  Hmmmn...~ */
  	IF ~!Global("VP_Ring_Is_Done","GLOBAL",1)
OR(3)
PartyHasItem("wa2ring")
PartyHasItem("ring35")
PartyHasItem("ring36")~ THEN GOTO IU300
...
IF ~~ THEN BEGIN IU3015
  ...
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ GOTO 52
END
...
DestroyGold(5000)~ GOTO 56
  IF ~PartyGoldLT(5000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 52
  IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that.  Anything else of use?~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 52
  IF ~~ THEN REPLY #59791 /* ~No, I don't think so.  I think I'll be going, now.~ */ DO ~SetGlobal("ForgeItem","GLOBAL",0)~ GOTO 12
END
END
