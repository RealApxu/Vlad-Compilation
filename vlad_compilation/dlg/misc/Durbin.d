...
IF ~~ THEN BEGIN D1a
  ...
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~Tell me Durbin, do you also have business with Lord Firkraag or was it he who locked you in here with these beasts?~ GOTO D2
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~What have we here? Seeing your predicament you certainly can't be another of Lord Firkraag's spies sent to spy on me.~ GOTO D2
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~Then you'd better hope you have information worth trading for your life!~ GOTO D17
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~Well met to you Durbin. If you could tell me where Lord Firkraag is holding the child of Garren Windspear, I'll deem that payment enough?~ GOTO D3
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~Well met to you Durbin. If you could tell me where Lord Firkraag  is hiding out, I'll deem that payment enough?~ GOTO D5
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) Global("FirkraagDeal","GLOBAL",0) Global("Firmag01Move","GLOBAL",0) InParty("Sharteel") !Dead("Sharteel") GlobalLT("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~I have no need for payment... it's all in a days work for an adventurer. You are free to go.~ EXTERN ~SHARTJ~ durbin1
  ...
  IF ~OR(3) Global("FirkraagDeal","GLOBAL",1) GlobalGT("Firmag01Move","GLOBAL",0) Global("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~Then maybe I'll take what little you do have in payment.~ GOTO D23
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) OR(3) Global("FirkraagDeal","GLOBAL",1) GlobalGT("Firmag01Move","GLOBAL",0) Global("VP_AngelosLegacy","GLOBAL",4) InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I have no need for payment... it's all in a days work for an adventurer. You are free to go.~ EXTERN ~SHARTJ~ durbin17
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) OR(3) Global("FirkraagDeal","GLOBAL",1) GlobalGT("Firmag01Move","GLOBAL",0) Global("VP_AngelosLegacy","GLOBAL",4) InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I have no need for payment... it's all in a days work for an adventurer. You are free to go.~ EXTERN ~SHARTJ~ durbin18
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) OR(3) Global("FirkraagDeal","GLOBAL",1) GlobalGT("Firmag01Move","GLOBAL",0) Global("VP_AngelosLegacy","GLOBAL",4)~ THEN REPLY ~So what are you, another of the dragon's servants? I don't see him rushing to save your skin from the Wolfweres.~ GOTO D25
END
...
IF ~~ THEN BEGIN D3
  ...
  IF ~InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~Get out of here, but I warn you, if you stand with your master against me I'll not hesitate in taking the life I have just saved.~ EXTERN ~SHARTJ~ durbin11
END
...
IF ~~ THEN BEGIN D7
  ...
  IF ~InParty("Sharteel") !Dead("Sharteel")~ THEN EXTERN ~SHARTJ~ durbin11
END
...
IF ~~ THEN BEGIN D23
  SAY ~(*Sighs*) So, this rescue is just a reprieve. I escape the bellies of the beasts only to find myself at the mercy of another type of beast. Ah well, I was already resigned to my fate, do as you will.~
  IF ~OR(2) !InParty("Sharteel") Dead("Sharteel")~ THEN DO ~EscapeArea()~ EXIT
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",1) InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I have no need for payment... it's all in a days work for an adventurer. You are free to go.~ EXTERN ~SHARTJ~ durbin17
  IF ~Global("SPRITE_IS_DEADfirkra02","GLOBAL",0) InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I have no need for payment... it's all in a days work for an adventurer. You are free to go.~ EXTERN ~SHARTJ~ durbin18
END
...
IF ~~ THEN BEGIN D25
  ...
  IF ~InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I've no quarrel with you, begone.~ EXTERN ~SHARTJ~ durbin20
  IF ~InParty("Sharteel") !Dead("Sharteel")~ THEN REPLY ~I don't think so. I'm coming back for the dragon and dealing with you will leave me ones less servant hindering my goal.~ EXTERN ~SHARTJ~ durbin20
