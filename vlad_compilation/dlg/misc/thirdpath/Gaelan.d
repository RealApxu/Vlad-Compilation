...
CHAIN GAELAN NEJ2
 SAY #20855
 IF ~~ THEN REPLY #20856 DO ~SetGlobalTimer("ImoenDream1","GLOBAL",ONE_DAY)~ GOTO 1
 IF ~~ THEN REPLY #20857 DO ~SetGlobalTimer("ImoenDream1","GLOBAL",ONE_DAY)~ GOTO 2
END
*/
...
DO ~AddXPObject(Player1,45000) AddXPObject(Player2,45000) AddXPObject(Player3,45000) AddXPObject(Player4,45000) AddXPObject(Player5,45000) AddXPObject(Player6,45000) SetGlobal("Attacked","LOCALS",2) SetGlobal("VP_Guild_Attacked","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPThirdP")~
EXIT
