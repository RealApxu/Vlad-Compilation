...
IF ~~ THEN BEGIN TS5
  ...
  IF ~InParty("Sime") Global("ThiefGroup","GLOBAL",1)~ THEN REPLY ~Then I suggest we go ashore and see if we can find some provisions or any clues to where we are. What about you, my trusty advisor?~ DO ~SetGlobal("Island_War","GLOBAL",1)~ EXTERN VPSIMJ 4
...
IF WEIGHT #5 ~Global("AsylumPlot","GLOBAL",1) OR(2)  Global("ThiefGroup","GLOBAL",0)  Global("ThiefGroup","GLOBAL",1) OR(2)  Global("VP_SailTo_Brynnlaw","GLOBAL",0)  Global("VP_SailTo_Brynnlaw","GLOBAL",3)~ THEN BEGIN 53
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime") !Dead("Sime")~ THEN DO ~SetGlobal("AsylumPlot","GLOBAL",2)~ JOURNAL #20632 FLAGS 128 EXTERN VPSIMJ 14
...
IF ~~ THEN BEGIN 54
  ...
  IF ~InParty("Sime")~ THEN EXTERN VPSIMJ 15
END
...
IF ~~ THEN BEGIN 117
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime") !Dead("Sime")~ THEN EXTERN VPSIMJ 14
