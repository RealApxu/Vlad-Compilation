...
IF ~~ THEN BEGIN TS81
  ...
  IF ~PartyGoldLT(5000) Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN REPLY ~Saemon, it sounds good, but I have not got enough coin.~ EXTERN ~SIMEJ~ sailoff2
  ...
  IF ~PartyGoldGT(4999) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~Well, what's life if not one big gamble! Take this money and cast your spell, Saemon, and if it fails I will see good old Harkle turned into a frog himself. But if it works, my friends prepare to storm Spellhold this afternoon!~ EXTERN ~KACHIJ~ sailoff2
...
IF ~~ THEN BEGIN TS0
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN EXTERN ~SIMEJ~ sailoff3
...
IF ~~ THEN BEGIN KR12
  ...
  IF ~PartyGoldGT(4999) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~Okay, take this money, and try to do your best.~ EXTERN ~KACHIJ~ sailoff2
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN EXTERN ~SIMEJ~ sailoff4
