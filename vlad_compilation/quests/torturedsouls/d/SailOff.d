...
IF ~~ THEN BEGIN 13
  ...
  IF ~InParty("vpkachi")~ THEN EXTERN VPKACJ sailoff1
...
~Global("AsylumPlot","GLOBAL",2) OR(2) Global("ThiefGroup","GLOBAL",0) Global("ThiefGroup","GLOBAL",1)~

APPEND PPSAEM

IF ~Global("ThiefGroup","GLOBAL",0) Global("AsylumPlot","GLOBAL",0) Global("VP_SailTo_Brynnlaw","GLOBAL",2)~ THEN BEGIN KR0
  ...
  IF ~~ THEN REPLY ~Yes, I've killed Aran Livnail and destroyed his guild, and you must be Saemon Havarian, the infamous captain mentioned in this letter. I need your ship to sail to Brynnlaw.~ DO ~SetGlobal("VP_SailTo_Brynnlaw","GLOBAL",3) AddXPObject(Player1,50000) AddXPObject(Player2,50000) AddXPObject(Player3,50000) AddXPObject(Player4,50000) AddXPObject(Player5,50000) AddXPObject(Player6,50000) TakePartyItem("aranlett")~ GOTO KR1
  IF ~~ THEN REPLY ~Yes, I've killed Aran Livnail and destroyed his guild. Here is the letter I've got from his corpse, but I presume you have been well aware of my soon arrival. I need your ship to sail to Brynnlaw.~ DO ~SetGlobal("VP_SailTo_Brynnlaw","GLOBAL",3) AddXPObject(Player1,50000) AddXPObject(Player2,50000) AddXPObject(Player3,50000) AddXPObject(Player4,50000) AddXPObject(Player5,50000) AddXPObject(Player6,50000) TakePartyItem("aranlett")~ GOTO KR1
  IF ~~ THEN REPLY ~(*Pretending to be surpsrised*) No, I haven't heard of his death, and if it's true, I am not responsible for that. Aran mentioned that you might be waiting for me in this tavern. I need your ship to sail to Brynnlaw.~ DO ~SetGlobal("VP_SailTo_Brynnlaw","GLOBAL",3) AddXPObject(Player1,50000) AddXPObject(Player2,50000) AddXPObject(Player3,50000) AddXPObject(Player4,50000) AddXPObject(Player5,50000) AddXPObject(Player6,50000) TakePartyItem("aranlett")~ GOTO KR1
END
...
IF ~~ THEN BEGIN KR1
  ...
  IF ~PartyGoldLT(10000) AreaCheck("AR0500")~ THEN REPLY #20988 GOTO KR4
  IF ~PartyGoldLT(10000) AreaCheck("AR0313")~ THEN REPLY #20988 GOTO KR6
END
...
IF ~Global("ThiefGroup","GLOBAL",0) Global("AsylumPlot","GLOBAL",0) Global("VP_SailTo_Brynnlaw","GLOBAL",3) Global("Start_Island","GLOBAL",0) Global("VP_Pay_to_Saemon","GLOBAL",0)~ THEN BEGIN KR5
  SAY ~Hey, <CHARNAME>.  It's nice to see you again. Have you gathered the required fee for me?~
  IF ~PartyGoldLT(10000) AreaCheck("AR0500")~ THEN REPLY #21031 GOTO KR4
  IF ~PartyGoldLT(10000) AreaCheck("AR0313")~ THEN REPLY #21031 GOTO KR6
  IF ~PartyGoldGT(9999)~ THEN REPLY #21033 GOTO KR2
END

IF ~Global("ThiefGroup","GLOBAL",0) Global("AsylumPlot","GLOBAL",0) Global("VP_SailTo_Brynnlaw","GLOBAL",3) Global("Start_Island","GLOBAL",0) Global("VP_Pay_to_Saemon","GLOBAL",1)~ THEN BEGIN KR5
  SAY ~Hey, <CHARNAME>.  It's nice to see you again. Have you gathered the required fee for me?~
  IF ~PartyGoldLT(15000) AreaCheck("AR0500")~ THEN REPLY #21031 GOTO KR4
  IF ~PartyGoldLT(15000) AreaCheck("AR0313")~ THEN REPLY #21031 GOTO KR6
  IF ~PartyGoldGT(14999)~ THEN REPLY #21033 GOTO KR21
END

IF ~~ THEN BEGIN KR21
  SAY ~Thank you. Well, then everything is settled. Here is the scroll.~
  IF ~~ THEN REPLY ~Cast your spell, Saemon, and if it fails I will see good old Harkle turned into a frog himself. But if it works, my friends prepare to storm Spellhold this afternoon!.~ EXTERN VPKACJ sailoff2
...
IF ~~ THEN BEGIN TS81
  ...
  IF ~PartyGoldLT(5000) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~Saemon, it sounds good, but I have not got enough coin.~ DO ~SetGlobal("VP_Pay_to_Saemon","GLOBAL",1)~  GOTO KR3
  ...
  IF ~PartyGoldLT(5000) Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN REPLY ~Saemon, it sounds good, but I have not got enough coin.~ EXTERN VPSIMJ sailoff2
  IF ~PartyGoldLT(5000) Global("ThiefGroup","GLOBAL",1) !InParty("Sime")~ THEN REPLY ~Saemon, it sounds good, but I have not got enough coin.~ EXTERN ~PPARAN2~ TS10
  IF ~~ THEN REPLY ~We will pay you, Saemon... if we are to survive this spell.~ GOTO TS0
  IF ~PartyGoldGT(4999) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~Well, what's life if not one big gamble! Take this money and cast your spell, Saemon, and if it fails I will see good old Harkle turned into a frog himself. But if it works, my friends prepare to storm Spellhold this afternoon!~ EXTERN VPKACJ sailoff2
...
IF ~~ THEN BEGIN TS0
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN EXTERN VPSIMJ sailoff3
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime")~ THEN EXTERN ~PPARAN2~ TS11
END

IF ~~ THEN BEGIN KR12
  SAY ~ You have paid me only for one way to Brynnlaw... Sorry to say, but business is business.~
  IF ~PartyGoldLT(5000) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~But I have not got enough coin.~ DO ~SetGlobal("VP_Pay_to_Saemon","GLOBAL",1)~ GOTO KR3
  IF ~PartyGoldGT(4999) Global("ThiefGroup","GLOBAL",0)~ THEN REPLY ~Okay, take this money, and try to do your best.~ EXTERN VPKACJ sailoff2
  ...
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN EXTERN VPSIMJ sailoff4
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime")~ THEN EXTERN ~PPARAN2~ TS12
END
...
IF ~~ THEN BEGIN TS2
  ...
  IF ~Global("ThiefGroup","GLOBAL",0)~ THEN DO ~TakePartyGold(15000) DestroyGold(15000) SetGlobal("Start_Island","GLOBAL",1) StartCutSceneMode() StartCutScene("VPMov03I")~ EXIT // ---> to the Island => VPMov03I => VPMov03J => CUT41kri
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN DO ~SetGlobal("Start_Island","GLOBAL",1) StartCutSceneMode() StartCutScene("Cut41is")~ EXIT // --->  to the Island with Sime being in-party
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime") Global("Sime_Meet","GLOBAL",0)~ THEN DO ~SetGlobal("Start_Island","GLOBAL",1) StartCutSceneMode() StartCutScene("Cut41isa")~ EXIT // ---> to the Island; in-game Sime is destroyed and re-created
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime") Global("Sime_Meet","GLOBAL",1)~ THEN DO ~SetGlobal("Start_Island","GLOBAL",1) StartCutSceneMode() StartCutScene("Cut41isS")~ EXIT // ---> to the Island; Sime is joinable and moved to the Island
END

IF ~~ THEN BEGIN TS9
  SAY #9749
  IF ~Global("ThiefGroup","GLOBAL",2)~ THEN DO ~StartCutSceneMode() StartCutScene("Cut41cc")~ EXIT // --->  to Brynnlaw with Bodhi
  IF ~Global("ThiefGroup","GLOBAL",0)~ THEN DO ~TakePartyGold(10000) DestroyGold(10000) StartCutSceneMode() StartCutScene("VPMov03K")~ EXIT // --->  to Brynnlaw (the Island is by-passed) => VPMov03K => VPMov03L => CUT41krb
  IF ~Global("ThiefGroup","GLOBAL",1) InParty("Sime")~ THEN DO ~StartCutSceneMode() StartCutScene("Cut41da")~ EXIT // --->  to Brynnlaw with Sime being in-party
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime") Global("Sime_Meet","GLOBAL",0)~ THEN DO ~StartCutSceneMode() StartCutScene("Cut41dd")~ EXIT // --->  to Brynnlaw without Yoshimo/Kachiko; in-game Sime is destroyed and re-created
  IF ~Global("ThiefGroup","GLOBAL",1) !InParty("Sime") Global("Sime_Meet","GLOBAL",1)~ THEN DO ~StartCutSceneMode() StartCutScene("Cut41dSA")~ EXIT  // ---> to Brynnlaw without Yoshimo/Kachiko; Sime is joinable and moved to Brynnlaw
END

//First reply to Aran
IF ~~ THEN BEGIN TS17
  SAY ~Of course.~
  IF ~~ THEN EXTERN VPSIMJ sailoff1
END
...
IF ~~ THEN BEGIN TS167
  ...
  IF ~~ THEN DO ~SetGlobal("Start_Island","GLOBAL",2)~ EXTERN VPKACJ sailoff3
END
...
IF ~~ THEN BEGIN TS22
  ...
  IF ~~ THEN EXTERN VPKACJ sailoff2
END
