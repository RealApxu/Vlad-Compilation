...
IF ~~ THEN BEGIN TS19
  ...
  IF ~~ THEN DO ~SetGlobalTimer("VP_KachikoRomance","GLOBAL",ONE_DAY) SetGlobal("Kicked_Out","LOCALS",0) JoinParty()~ EXIT
END
...
IF ~~ THEN BEGIN TS10
  ...
  IF ~Global("VP_Kachiko_Joined","GLOBAL",0) OR(2) AreaCheck("AR0313") AreaCheck("AR0406")~ THEN DO ~SetGlobal("Kicked_Out","LOCALS",0)~ EXTERN ~KACHIKO~ 23
  IF ~Global("VP_Kachiko_Joined","GLOBAL",0) !AreaCheck("AR0313") !AreaCheck("AR0406")~ THEN DO ~SetGlobal("Kicked_Out","LOCALS",0)~ EXTERN ~KACHIKO~ 24
  IF ~Global("VP_Kachiko_Joined","GLOBAL",1) OR(2) AreaCheck("AR0313") AreaCheck("AR0406")~ THEN DO ~SetGlobal("Kicked_Out","LOCALS",0)~ EXTERN ~KACHIP~ 0
  IF ~Global("VP_Kachiko_Joined","GLOBAL",1) !AreaCheck("AR0313") !AreaCheck("AR0406")~ THEN DO ~SetGlobal("Kicked_Out","LOCALS",0)~ EXTERN ~KACHIP~ 1
END
...
IF ~~ THEN BEGIN TS21
  ...
  IF ~~ THEN DO ~SetGlobal("Kicked_Out","LOCALS",1) EscapeAreaMove("TT0307",243,876,10)~ EXIT
END
