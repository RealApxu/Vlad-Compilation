...
EXTEND_BOTTOM AERIEP 6
 IF ~OR(2) !Global("VP_InHalruaa","GLOBAL",0) !Global("VP_OnIsland","GLOBAL",0)~ THEN REPLY #48308 DO ~SetGlobal("KickedOut","LOCALS",1)~ EXIT
END
...
IF ~~ THEN BEGIN A19 // from:
 ...
 IF ~~ THEN DO ~SetGlobal("AerieMove","GLOBAL",1) SetGlobal("TicketTaker","GLOBAL",1)~ EXIT
END
