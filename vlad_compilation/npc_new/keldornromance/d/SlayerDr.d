...
IF WEIGHT #4 ~Global("Kr_Slayer_Talk","GLOBAL",0) Global("Kr_SlayerTalk_Fix","GLOBAL",1) Global("VP_Kr_PreWedding","GLOBAL",0)~ THEN BEGIN S0
...
IF ~~ THEN BEGIN S41
  ...
  IF ~~ THEN DO ~SetGlobal("Kr_SlayerTalk_Fix","GLOBAL",2) ClearAllActions() StartCutSceneMode() StartCutScene("MovieKr2")~ EXIT
END

IF WEIGHT #3 ~Global("Kr_Slayer_Talk","GLOBAL",0) Global("Kr_SlayerTalk_Fix2","GLOBAL",1) !Global("VP_Kr_PreWedding","GLOBAL",0)~ THEN BEGIN S5
...
IF ~~ THEN BEGIN S11
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Slayer_Again","GLOBAL",3) SetGlobal("VP_Kr_NextTalk","GLOBAL",5) RealSetGlobalTimer("VP_ToB_Kr_RTimer","GLOBAL",1800) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut29")~ EXIT
END
...
IF ~~ THEN BEGIN S15
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Slayer_Farewell","GLOBAL",3) ClearAllActions() StartCutSceneMode() StartCutScene("KRCut29")~ EXIT
END
