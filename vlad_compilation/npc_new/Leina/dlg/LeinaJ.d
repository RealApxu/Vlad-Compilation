...
== VPLEIJ ~I am anxious to be away from here, but not before letting Samuel know I am safe. Let us make our way to the tavern together.~
EXIT
...
== VPLEIJ ~No one knows what fate has around the corner for us to learn or experience. There was maybe, such a corner waiting for Govan to turn, but now it is too late.~
== VPLEIJ ~Let us leave this place, but if you do not mind, I would like to let Samuel know that I am well before we leave. Let us make our way to the tavern together.~
EXIT
...
== VPLEIJ ~Could I have saved you some of this pain if only my stupid pride had let me come home. If only...~
END
 IF ~GlobalLT("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina we must leave here quickly, time is not on our side.~ EXTERN VPLEIJ 14
 IF ~GlobalLT("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina, pull yourself together! This is not the time for what ifs. That is a fruitless road to start going down.~ EXTERN VPLEIJ 14
 IF ~GlobalLT("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina, our business here is done, now get a grip on yourself and move!~ EXTERN VPLEIJ 14
 IF ~GlobalLT("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Look, I am sorry Leina, believe me, I did all that I could to reason with him. In the end it was him or me.~ EXTERN VPLEIJ 14
 IF ~Global("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina we must leave here quickly, time is not on our side.~ EXTERN VPLEIJ N14
 IF ~Global("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina, pull yourself together! This is not the time for what ifs. That is a fruitless road to start going down.~ EXTERN VPLEIJ N14
 IF ~Global("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Leina, our business here is done, now get a grip on yourself and move!~ EXTERN VPLEIJ N14
 IF ~Global("VP_MyFatherIsDead","LOCALS",3)~ REPLY ~Look, I am sorry Leina, believe me, I did all that I could to reason with him. In the end it was him or me.~ EXTERN VPLEIJ N14

CHAIN VPLEIJ 14
~I just needed a moment, <CHARNAME>. I do not blame you in any way for this.~
== VPLEIJ ~My mother's death changed him, he could not face life without her, and I think he sought to keep me here to take her place, but I hope that now he has found some peace.~
== VPLEIJ ~I have no idea how you found me but I will always be grateful that you did. Come, <CHARNAME>, let us begone from here!~
END
...
END
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ EXTERN FFBART NEJ74
...
== VPLEIJ ~My only consolation is that he is now free of his grief and torment, I would not have wished him to continue his life in so much anguish.~
END
 IF ~!Global("BodhiJob","GLOBAL",0)~ EXTERN VPLEIJ 29
 IF ~Global("BodhiJob","GLOBAL",0) Global("VP_Guild_Attacked","GLOBAL",1)~ EXTERN VPLEIJ N29

CHAIN VPLEIJ 29
~What I cannot forgive is the fact that he died to appease that creature you serve, nor shall I forget it!~
== VPLEIJ ~This is too painful for me to face at this time, <CHARNAME>, for now, I do not wish to speak any further with you.~
...
== VPLEIJ ~My only consolation is that my father is alive, but what I cannot forgive is the fact that you act to appease that creature you serve, nor shall I forget it!~
== VPLEIJ ~This is too painful for me to face at this time, <CHARNAME>, for now, I do not wish to speak any further with you.~
EXTERN BODHI 65
...
END
/*1*/ IF ~Global("VP_Flirt_Option_1","LOCALS",0)~ REPLY ~(*You deliberately slow your pace so's to fall in alongside Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_1","LOCALS",1)~ EXTERN VPLEIJ 38 // => Leina response 1.1
/*1*/ IF ~Global("VP_Flirt_Option_1","LOCALS",1)~ REPLY ~(*You deliberately slow your pace so's to fall in alongside Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_1","LOCALS",2)~ EXTERN VPLEIJ 39 // => Leina response 1.2
/*1*/ IF ~Global("VP_Flirt_Option_1","LOCALS",2)~ REPLY ~(*You deliberately slow your pace so's to fall in alongside Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_1","LOCALS",0)~ EXTERN VPLEIJ 40 // => Leina response 1.3
/*2*/ IF ~Global("VP_Flirt_Option_2","LOCALS",0)~ REPLY ~(*You start to hum to yourself as you move position so that you end up walking behind Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_2","LOCALS",1)~ EXTERN VPLEIJ 41 // => Leina response 2.1
/*2*/ IF ~Global("VP_Flirt_Option_2","LOCALS",1)~ REPLY ~(*You start to hum to yourself as you move position so that you end up walking behind Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_2","LOCALS",2)~ EXTERN VPLEIJ 42 // => Leina response 2.2
/*2*/ IF ~Global("VP_Flirt_Option_2","LOCALS",2)~ REPLY ~(*You start to hum to yourself as you move position so that you end up walking behind Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_2","LOCALS",0)~ EXTERN VPLEIJ 43 // => Leina response 2.3
/*3*/ IF ~Global("VP_Flirt_Option_3","LOCALS",0)~ REPLY ~(*You flash a smile at Leina and then look away quickly.*)~ DO ~SetGlobal("VP_Flirt_Option_3","LOCALS",1)~ EXTERN VPLEIJ 44 // => Leina response 3.1
/*3*/ IF ~Global("VP_Flirt_Option_3","LOCALS",1)~ REPLY ~(*You flash a smile at Leina and then look away quickly.*)~ DO ~SetGlobal("VP_Flirt_Option_3","LOCALS",2)~ EXTERN VPLEIJ 45 // => Leina response 3.2
/*3*/ IF ~Global("VP_Flirt_Option_3","LOCALS",2)~ REPLY ~(*You flash a smile at Leina and then look away quickly.*)~ DO ~SetGlobal("VP_Flirt_Option_3","LOCALS",0)~ EXTERN VPLEIJ 46 // => Leina response 3.3
/*4*/ IF ~Global("VP_Flirt_Option_4","LOCALS",0)~ REPLY ~(*You flash a smile at Leina and allow your eye to linger a little longer on the beauty of her exotic features.*)~ DO ~SetGlobal("VP_Flirt_Option_4","LOCALS",1)~ EXTERN VPLEIJ 47 // => Leina response 4.1
/*4*/ IF ~Global("VP_Flirt_Option_4","LOCALS",1)~ REPLY ~(*You flash a smile at Leina and allow your eye to linger a little longer on the beauty of her exotic features.*)~ DO ~SetGlobal("VP_Flirt_Option_4","LOCALS",2)~ EXTERN VPLEIJ 48 // => Leina response 4.2
/*4*/ IF ~Global("VP_Flirt_Option_4","LOCALS",2)~ REPLY ~(*You flash a smile at Leina and allow your eye to linger a little longer on the beauty of her exotic features.*)~ DO ~SetGlobal("VP_Flirt_Option_4","LOCALS",0)~ EXTERN VPLEIJ 49 // => Leina response 4.3
/*5*/ IF ~Global("VP_Flirt_Option_5","LOCALS",0)~ REPLY ~(*You whistle appreciatively at Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_5","LOCALS",1)~ EXTERN VPLEIJ 50 // => Leina response 5.1
/*5*/ IF ~Global("VP_Flirt_Option_5","LOCALS",1)~ REPLY ~(*You whistle appreciatively at Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_5","LOCALS",2)~ EXTERN VPLEIJ 51 // => Leina response 5.2
/*5*/ IF ~Global("VP_Flirt_Option_5","LOCALS",2)~ REPLY ~(*You whistle appreciatively at Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_5","LOCALS",0)~ EXTERN VPLEIJ 52 // => Leina response 5.3
/*6*/ IF ~Global("VP_Flirt_Option_6","LOCALS",0)~ REPLY ~Hey Leina, watch this ... *you pull a funny face as she turns around.*~ DO ~SetGlobal("VP_Flirt_Option_6","LOCALS",1)~ EXTERN VPLEIJ 53 // => Leina response 6.1
/*6*/ IF ~Global("VP_Flirt_Option_6","LOCALS",1)~ REPLY ~Hey Leina, watch this ... *you pull a funny face as she turns around.*~ DO ~SetGlobal("VP_Flirt_Option_6","LOCALS",2)~ EXTERN VPLEIJ 54 // => Leina response 6.2
/*6*/ IF ~Global("VP_Flirt_Option_6","LOCALS",2)~ REPLY ~Hey Leina, watch this ... *you pull a funny face as she turns around.*~ DO ~SetGlobal("VP_Flirt_Option_6","LOCALS",0)~ EXTERN VPLEIJ 55 // => Leina response 6.3
/*7*/ IF ~Global("VP_Flirt_Option_7","LOCALS",0)~ REPLY ~(*You wave to Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_7","LOCALS",1)~ EXTERN VPLEIJ 56 // => Leina response 7.1
/*7*/ IF ~Global("VP_Flirt_Option_7","LOCALS",1)~ REPLY ~(*You wave to Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_7","LOCALS",2)~ EXTERN VPLEIJ 57 // => Leina response 7.2
/*7*/ IF ~Global("VP_Flirt_Option_7","LOCALS",2)~ REPLY ~(*You wave to Leina.*)~ DO ~SetGlobal("VP_Flirt_Option_7","LOCALS",0)~ EXTERN VPLEIJ 58 // => Leina response 7.3
/*8*/ IF ~Global("VP_Flirt_Option_8","LOCALS",0)~ REPLY ~Uh... nothing Leina, we should keep walking.~ DO ~SetGlobal("VP_Flirt_Option_8","LOCALS",1)~ EXTERN VPLEIJ 59 // => Leina response 8.1
/*8*/ IF ~Global("VP_Flirt_Option_8","LOCALS",1)~ REPLY ~Uh... nothing Leina, we should keep walking.~ DO ~SetGlobal("VP_Flirt_Option_8","LOCALS",2)~ EXTERN VPLEIJ 60 // => Leina response 8.2
/*8*/ IF ~Global("VP_Flirt_Option_8","LOCALS",2)~ REPLY ~Uh... nothing Leina, we should keep walking.~ DO ~SetGlobal("VP_Flirt_Option_8","LOCALS",0)~ EXTERN VPLEIJ 61 // => Leina response 8.3
...
END
 IF ~True()~ THEN EXIT
 IF ~InParty("Korgan") !Dead("Korgan")~ EXTERN KORGANJ NEJ224
 IF ~InParty("Jan") !Dead("Jan")~ EXTERN JANJ NEJ200
 IF ~InParty("Valygar") !Dead("Valygar")~ EXTERN VALYGARJ NEJ166
 IF ~InParty("Anomen") !Dead("Anomen")~ EXTERN ANOMENJ NEJ312
 IF ~InParty("Keldorn") !Dead("Keldorn")~ EXTERN KELDORJ NEJ255
 IF ~InParty("njdar") !Dead("njdar")~ EXTERN NJDARJ 70
 IF ~InParty("Sime") !Dead("Sime")~ EXTERN VPSIMJ NEJ119
 IF ~InParty("Edwin") !Dead("Edwin")~ EXTERN EDWINJ NEJ199
 IF ~InParty("Nalia") !Dead("Nalia")~ EXTERN NALIAJ NEJ333
 IF ~InParty("Aerie") !Dead("Aerie")~ EXTERN AERIEJ NEJ235
 IF ~InParty("Minsc") !Dead("Minsc")~ EXTERN MINSCJ NEJ331
 IF ~InParty("Yoshimo") !Dead("Yoshimo")~ EXTERN YOSHJ NEJ156
 IF ~InParty("Jaheira") !Dead("Jaheira")~ EXTERN JAHEIRAJ NEJ634
...
END
 IF ~True()~ EXTERN NJHROJ 335
 IF ~InParty("njtaffic") !Dead("njtaffic")~ EXTERN NJTAFJ leveler1
 IF ~InParty("njmelora") !Dead("njmelora")~ EXTERN NJMELJ 25
 IF ~InParty("Jan") !Dead("Jan")~ EXTERN JANJ NEJ201
...
DO ~SetGlobal("VP_Leina_Samuel","GLOBAL",3)~
EXTERN VPLEIJ 91
...
DO ~SetGlobalTimer("VP_LetsVisitSamuel","GLOBAL",ONE_DAY)~
EXIT
...
== VPLEIJ ~I am not about to have him hear of my return from another and cause him hurt by having him think I couldn't spare the time, or the courtesy to visit with him.~
== VPLEIJ ~When you are done here, you know where to find me, that is, if it is your wish that we continue our journey together. Farewell for now.~
DO ~ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) LeaveParty() MoveGlobal("AR0509","vpleina",[313.437])~
EXIT
...
DO ~SetGlobal("VP_Leina_Samuel","GLOBAL",5)~
== VPLEIJ ~I will not cause him hurt or to have him think me ungrateful. I am leaving for The Five Flagons to see my old friend, will you accompany me <CHARNAME>?~
END
...
== VPLEIJ ~I wish you well, and please, if you have need of me at some future time, look for me at the inn... but first, I have an old friend to visit with. Farewell and good luck.~
DO ~ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) SetGlobal("VP_Leina_Samuel","GLOBAL",7) LeaveParty() MoveGlobal("AR0509","vpleina",[313.437])~
EXIT
...
== VPLEIJ ~For now, I must bid you farewell but know that I wish you luck in your endeavours. If you should reconsider and find you need my aid, you know where I am to be found.~
DO ~ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) SetGlobal("VP_Leina_Samuel","GLOBAL",7) LeaveParty() MoveGlobal("AR0509","vpleina",[313.437])~
EXIT
...
DO ~SetGlobal("VP_Leina_Samuel","GLOBAL",5)~
== VPLEIJ ~I am sorry but I must return, I will not have Samuel knowing of my return and thinking I couldn't spare him the courtesy of a visit... I will not cause him hurt or to have him think me ungrateful. Will you accompany me or must I travel alone?~
END
 ++ ~I'm sorry Leina, I have so much going on my mind at the moment... I completely forgot your request to see Samuel. Come, we will leave for the inn immediately.~ EXTERN VPLEIJ 92
 ++ ~If I could afford to be one down in numbers, then I would say go visit your barkeep, but as you are needed I will accompany you this one time... if only to ensure you keep your reunion brief!~ EXTERN VPLEIJ 92
 ++ ~There is still so much to do, I can not spare the time but we will, I am sure, return soon. You can visit your friend then.~ EXTERN VPLEIJ 99
...
~Yes... you need me for something?~
END
 IF ~Global("SPRITE_IS_DEADVulova","GLOBAL",1)~ REPLY ~I can't help but notice the shadows that pass before your eyes every time you touch your pendant Leina. Is it thoughts of your father that bring such sadness to those beautiful eyes of yours?~ EXTERN VPLEIJ LFlirts901
 IF ~Global("SPRITE_IS_DEADVulova","GLOBAL",0)~ REPLY ~I can't help but notice the shadows that pass before your eyes every time you touch your pendant Leina. Is it thoughts of your father that bring such sadness to those beautiful eyes of yours?~ EXTERN VPLEIJ LFlirts905
 ...
 IF ~!AreaType(CITY) OR(2) AreaType(OUTDOOR) AreaType(FOREST)~ REPLY ~Leina how would you feel if we were forced to spend a little time in Athkatla again? I know you have bad memories of the place and were in a rush to leave, but I feel we have not yet seen the last of the city?~ EXTERN VPLEIJ LFlirts1101
 IF ~Global("VP_Flirt_Option_12","LOCALS",0) GlobalTimerExpired("VP_FlirtPoetry","GLOBAL")~ REPLY ~Leina, would you please honour me with a tale to while away some time whilst it is quiet?~ EXTERN VPLEIJ LFlirts1201
 IF ~Global("VP_Flirt_Option_12","LOCALS",1)~ REPLY ~Leina, would you please honour me with a tale to while away some time whilst it is quiet?~ EXTERN VPLEIJ LFlirts1202
 ++ ~Tell me Leina, does knowing who my father is, influence your feelings towards me?~ EXTERN VPLEIJ LFlirts1301
 IF ~Global("VP_Flirt_Option_14","LOCALS",0)~ REPLY ~You're looking lovelier than ever today Leina. Is it your hair... are you wearing it differently?~ EXTERN VPLEIJ LFlirts1401
 IF ~Global("VP_Flirt_Option_14","LOCALS",1)~ REPLY ~You're looking lovelier than ever today Leina. Is it your hair... are you wearing it differently?~ EXTERN VPLEIJ LFlirts1402
 IF ~Global("VP_Flirt_Option_14","LOCALS",2)~ REPLY ~You're looking lovelier than ever today Leina. Is it your hair... are you wearing it differently?~ EXTERN VPLEIJ LFlirts1403
...
DO ~SetGlobal("VP_Flirt_Option_12","LOCALS",1)~
EXIT
...
END
 IF ~Gender(Player1,MALE) Global("VP_MyFlirt_Is_Over","LOCALS",0)~ REPLY ~(*You reach around and touch her face, gently turning it so that she is facing you... then looking into her eyes you speak*) I am sorry Leina, the last thing I wanted was to open up old wounds. Here take my hand, we will leave this place and speak no more of dragons.~ EXTERN VPLEIJ firkdead10
 IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ REPLY ~I am sorry Leina, I didn't mean to pry.~ EXTERN VPLEIJ firkdead7
 IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ REPLY ~You were close to this teacher... I am sorry I didn't mean to open up old wounds forgive me.~ EXTERN VPLEIJ firkdead7
 IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ REPLY ~So these teachers of yours died before they could fill your head with more nonsense. Seems fate did you a favour.~ EXTERN VPLEIJ firkdead11
...
~Yes... you need me for something?~
END
/*15*/ IF ~Global("VP_Flirt_Option_15","LOCALS",0)~ REPLY ~(*You come up behind Leina and gently blow in to the back of her neck.*)~ DO ~SetGlobal("VP_Flirt_Option_15","LOCALS",1)~ EXTERN VPLEIJ NF1501
/*15*/ IF ~Global("VP_Flirt_Option_15","LOCALS",1)~ REPLY ~(*You come up behind Leina and gently blow in to the back of her neck.*)~ DO ~SetGlobal("VP_Flirt_Option_15","LOCALS",2)~ EXTERN VPLEIJ NF1502
/*15*/ IF ~Global("VP_Flirt_Option_15","LOCALS",2)~ REPLY ~(*You come up behind Leina and gently blow in to the back of her neck.*)~ DO ~SetGlobal("VP_Flirt_Option_15","LOCALS",0)~ EXTERN VPLEIJ NF1503
/*16*/ IF ~Global("VP_Flirt_Option_16","LOCALS",0)~ REPLY ~A gold piece for your thoughts Leina? You've been staring at me very intensely for some time now.~ DO ~SetGlobal("VP_Flirt_Option_16","LOCALS",1)~ EXTERN VPLEIJ NF1601
/*16*/ IF ~Global("VP_Flirt_Option_16","LOCALS",1)~ REPLY ~A gold piece for your thoughts Leina? You've been staring at me very intensely for some time now.~ DO ~SetGlobal("VP_Flirt_Option_16","LOCALS",2)~ EXTERN VPLEIJ NF1602
/*16*/ IF ~Global("VP_Flirt_Option_16","LOCALS",2)~ REPLY ~A gold piece for your thoughts Leina? You've been staring at me very intensely for some time now.~ DO ~SetGlobal("VP_Flirt_Option_16","LOCALS",0)~ EXTERN VPLEIJ NF1603
...
/*18*/ IF ~Global("VP_Flirt_Option_18","LOCALS",0)~ REPLY ~I was thinking aloud Leina. Your husband was a fool not to recognise the value of the jewel he held in his hand.~ DO ~SetGlobal("VP_Flirt_Option_18","LOCALS",1)~ EXTERN VPLEIJ NF1801
/*18*/ IF ~Global("VP_Flirt_Option_18","LOCALS",1)~ REPLY ~I was thinking aloud Leina. Your husband was a fool not to recognise the value of the jewel he held in his hand.~ DO ~SetGlobal("VP_Flirt_Option_18","LOCALS",2)~ EXTERN VPLEIJ NF1802
/*18*/ IF ~Global("VP_Flirt_Option_18","LOCALS",2)~ REPLY ~I was thinking aloud Leina. Your husband was a fool not to recognise the value of the jewel he held in his hand.~ DO ~SetGlobal("VP_Flirt_Option_18","LOCALS",0)~ EXTERN VPLEIJ NF1803
...
END
 ...
 IF ~Global("VP_Flirt_Option_H2","LOCALS",0)~ REPLY ~(*You let your eye run appreciatively over Leina*) A wizard's garb is very becoming on you Leina, it's almost a crime to hide so much beauty under armour again.~ DO ~SetGlobal("VP_Flirt_Option_H2","LOCALS",1)~ EXTERN VPLEIJ HF201
 IF ~Global("VP_Flirt_Option_H2","LOCALS",1)~ REPLY ~(*You let your eye run appreciatively over Leina*) A wizard's garb is very becoming on you Leina, it's almost a crime to hide so much beauty under armour again.~ DO ~SetGlobal("VP_Flirt_Option_H2","LOCALS",2)~ EXTERN VPLEIJ HF202
 IF ~Global("VP_Flirt_Option_H2","LOCALS",2)~ REPLY ~(*You let your eye run appreciatively over Leina*) A wizard's garb is very becoming on you Leina, it's almost a crime to hide so much beauty under armour again.~ DO ~SetGlobal("VP_Flirt_Option_H2","LOCALS",0)~ EXTERN VPLEIJ HF203
 IF ~InParty("njdar") !Dead("njdar") Global("VP_Flirt_Option_H3","LOCALS",0)~ REPLY ~(*You whisper to Leina softly*) Keep your eye on Dar, Leina. If he trips on his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_H3","LOCALS",1)~ EXTERN VPLEIJ HF302
 IF ~InParty("njdar") !Dead("njdar") Global("VP_Flirt_Option_H3","LOCALS",1)~ REPLY ~(*You whisper to Leina softly*) Keep your eye on Dar, Leina. If he trips on his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_H3","LOCALS",0)~ EXTERN VPLEIJ HF303
 IF ~Global("VP_Flirt_Option_31","LOCALS",0) OR(2) !InParty("njdar") Dead("njdar")~ REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",1)~ EXTERN VPLEIJ HF301
 IF ~Global("VP_Flirt_Option_31","LOCALS",1) OR(2) !InParty("njdar") Dead("njdar")~ REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",2)~ EXTERN VPLEIJ HF302
 IF ~Global("VP_Flirt_Option_31","LOCALS",2) OR(2) !InParty("njdar") Dead("njdar")~ REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",3)~ EXTERN VPLEIJ HF303
...
== BODHIAMB ~You misunderstand me completely, bard. I am going to leave him his pathetic life. But yours I shall have. Follow me further <CHARNAME>, and you will lose more than you can imagine. Starting now!~
DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCut53s")~
JOURNAL ~The Final Battle with Bodhi.
...
END
 ...
 IF ~InParty("Minsc") !Dead("Minsc")~ EXTERN MINSCJ 203
 IF ~InParty("Cernd") !Dead("Cernd")~ EXTERN CERNDJ 130
 IF ~InParty("HaerDalis") !Dead("HaerDalis")~ EXTERN HAERDAJ 141
 IF ~InParty("Mazzy") !Dead("Mazzy")~ EXTERN MAZZYJ 194
 IF ~InParty("Nalia") !Dead("Nalia")~ EXTERN NALIAJ 308
 IF ~InParty("Jan") !Dead("Jan")~ EXTERN JANJ 178
 IF ~InParty("Korgan") !Dead("Korgan")~ EXTERN KORGANJ 177
 IF ~InParty("Keldorn") !Dead("Keldorn") !Global("VP_KrRomanceActive","GLOBAL",1) !Global("VP_KrRomanceActive","GLOBAL",2)~ EXTERN KELDORJ 243
 IF ~InParty("Valygar") !Dead("Valygar") !Global("ValygarRomanceActive","GLOBAL",1) !Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYGARJ 103
 IF ~InParty("Edwin") !Dead("Edwin")~ EXTERN EDWINJ 149
 IF ~InParty("Anomen") !Dead("Anomen")~ EXTERN ANOMENJ 250
 IF ~InParty("Aerie") !Dead("Aerie")~ EXTERN AERIEJ 116
 IF ~InParty("Viconia") !Dead("Viconia")~ EXTERN VICONIJ 87
 IF ~InParty("Jaheira") !Dead("Jaheira")~ EXTERN JAHEIRAJ 432
 IF ~InParty("Imoen2") !Dead("Imoen2")~ EXTERN IMOEN2J 1
...
END
 IF ~True()~ THEN EXIT
 IF ~InParty("Edwin") See("Edwin")~ EXTERN EDWINJ 95
 IF ~InParty("Nalia") See("Nalia")~ EXTERN NALIAJ 268
 IF ~InParty("Keldorn") See("Keldorn")~ EXTERN KELDORJ 189
 IF ~InParty("Haerdalis") See("Haerdalis")~ EXTERN HAERDAJ 100
 IF ~InParty("Anomen") See("Anomen")~ EXTERN ANOMENJ 258
 IF ~InParty("Mazzy") See("Mazzy")~ EXTERN MAZZYJ 166
 IF ~InParty("Cernd") See("Cernd")~ EXTERN CERNDJ 100
 IF ~InParty("Jaheira") See("Jaheira")~ EXTERN JAHEIRAJ 450
 IF ~InParty("Yoshimo") See("Yoshimo")~ EXTERN YOSHJ 90
 IF ~InParty("Viconia") See("Viconia")~ EXTERN VICONIJ 117
 IF ~InParty("Jan") See("Jan")~ EXTERN JANJ 147
 IF ~InParty("Korgan") See("Korgan")~ EXTERN KORGANJ 115
 IF ~InParty("Valygar") See("Valygar")~ EXTERN VALYGARJ 77
 IF ~InParty("Minsc") See("Minsc")~ EXTERN MINSCJ 155
 IF ~InParty("Aerie") See("Aerie")~ EXTERN AERIEJ 131
 IF ~InParty("Imoen2") See("Imoen2")~ EXTERN IMOEN2J 10
 IF ~InParty("vpkachi") See("vpkachi")~ EXTERN VPKACJ N55
...
END
 IF ~True()~ EXTERN PLAYER1 53
 IF ~InParty("Anomen") Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 52
 IF ~InParty("Aerie") Global("AerieRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 51
 IF ~InParty("Viconia") Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 50
 IF ~InParty("Jaheira") Global("JaheiraRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 49
 IF ~InParty("Anomen") !Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 48
 IF ~InParty("Aerie") !Global("AerieRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 47
 IF ~InParty("Viconia") !Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 46
 IF ~InParty("Jaheira") !Global("JaheiraRomanceActive","GLOBAL",2)~ EXTERN PLAYER1 45
 IF ~InParty("Cernd")~ EXTERN PLAYER1 44
 IF ~InParty("Nalia")~ EXTERN PLAYER1 43
 IF ~InParty("Korgan")~ EXTERN PLAYER1 42
 IF ~InParty("Keldorn") Global("VP_KrRomanceActive","GLOBAL",0)~ EXTERN PLAYER1 41
 IF ~InParty("HaerDalis")~ EXTERN PLAYER1 40
 IF ~InParty("Edwin")~ EXTERN PLAYER1 39
 IF ~InParty("Jan")~ EXTERN PLAYER1 38
 IF ~InParty("Mazzy")~ EXTERN PLAYER1 37
 IF ~InParty("Valygar")~ EXTERN PLAYER1 36
 IF ~InParty("Minsc")~ EXTERN PLAYER1 35
 IF ~InParty("Imoen2")~ EXTERN PLAYER1 34
 IF ~InParty("vpkachi")~ EXTERN PLAYER1 TS55
 IF ~InParty("Yoshimo")~ EXTERN PLAYER1 TS55yosh
 IF ~InParty("Keldorn") !Global("VP_KrRomanceActive","GLOBAL",0)~ EXTERN PLAYER1 KR_TL0
...
END
 IF ~!Alignment(Player1,MASK_EVIL)~ EXTERN VPLEIJ TSTOB10
 IF ~Alignment(Player1,MASK_EVIL)~ EXTERN VPLEIJ TSTOB11
...
END
 IF ~True()~ EXTERN FINSOL01 28
 IF ~InParty("Valygar") Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYG25J 3
 IF ~InParty("Anomen") Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN ANOME25J 11
 IF ~InParty("Valygar") !Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYG25J 2
 IF ~InParty("Anomen") !Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN ANOME25J 10
 IF ~InParty("Viconia") !Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN VICON25J 6
 IF ~InParty("Aerie") !Global("AerieRomanceActive","GLOBAL",2)~ EXTERN AERIE25J 7
 IF ~InParty("Jaheira") !Global("JaheiraRomanceActive","GLOBAL",2)~ EXTERN JAHEI25J 7
 IF ~InParty("Imoen2")~ EXTERN IMOEN25J 15
 IF ~InParty("Sarevok") !Alignment("Sarevok",MASK_EVIL)~ EXTERN SAREV25J 2
 IF ~InParty("Sarevok") Alignment("Sarevok",MASK_EVIL)~ EXTERN SAREV25J 3
 IF ~InParty("Minsc")~ EXTERN MINSC25J 0
 IF ~InParty("Nalia")~ EXTERN NALIA25J 1
 IF ~InParty("HaerDalis")~ EXTERN HAERD25J 1
 IF ~InParty("Jan")~ EXTERN JAN25J 3
 IF ~InParty("Cernd")~ EXTERN CERND25J 0
 IF ~InParty("Mazzy")~ EXTERN MAZZY25J 0
 IF ~InParty("Edwin")~ EXTERN EDWIN25J 0
 IF ~InParty("Korgan")~ EXTERN KORGA25J 2
 IF ~InParty("Keldorn")~ EXTERN KELDO25J 0
 IF ~InParty("vpkachi")~ EXTERN VPKAC25J 3
 IF ~InParty("Yoshimo")~ EXTERN YOSHJ TS231
...
END
 IF ~True()~ EXTERN FINSOL01 33
 IF ~InParty("Valygar") Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYG25J 11
 IF ~InParty("Anomen") Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN ANOME25J 20
 IF ~InParty("Viconia") Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN VICON25J 18
 IF ~InParty("Aerie") Global("AerieRomanceActive","GLOBAL",2)~ EXTERN AERIE25J 20
 IF ~InParty("Jaheira") Global("JaheiraRomanceActive","GLOBAL",2)~ EXTERN JAHEI25J 18
 IF ~InParty("Imoen2")~ EXTERN IMOEN25J 18
 IF ~InParty("Sarevok") Alignment("Sarevok",MASK_EVIL)~ EXTERN SAREV25J 4
 IF ~InParty("Sarevok") !Alignment("Sarevok",MASK_EVIL)~ EXTERN SAREV25J 6
...
END
 ...
 IF ~InParty("Valygar") Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYG25J 3
 IF ~InParty("Anomen") Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN ANOME25J 11
 IF ~InParty("Viconia") Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN VICON25J 8
 IF ~InParty("Aerie") Global("AerieRomanceActive","GLOBAL",2)~ EXTERN AERIE25J 9
 IF ~InParty("Jaheira") Global("JaheiraRomanceActive","GLOBAL",2)~ EXTERN JAHEI25J 9
 IF ~InParty("Valygar") !Global("ValygarRomanceActive","GLOBAL",2)~ EXTERN VALYG25J 2
 IF ~InParty("Anomen") !Global("AnomenRomanceActive","GLOBAL",2)~ EXTERN ANOME25J 10
 IF ~InParty("Viconia") !Global("ViconiaRomanceActive","GLOBAL",2)~ EXTERN VICON25J 6
 IF ~InParty("Aerie") !Global("AerieRomanceActive","GLOBAL",2)~ EXTERN AERIE25J 7
