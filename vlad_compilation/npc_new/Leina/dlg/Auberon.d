...
CHAIN AUBERON 1
~Shut up, Govan!~
== AUBERON ~I would like to hear your story, Leina.~
...
== AUBERON ~I cannot believe a son of mine capable of such things. What have we raised?~
END
...
== AUBERON ~And you, Govan, have dealings with that low-life Killian? After the trouble he brought upon the Duvaine family, what sort of a son are you, Govan?~
END
...
== AUBERON ~We, <CHARNAME>, have no quarrel with each other. That low-life Killian your deal is with, is naught but a hired assassin. What say we end this now?~
END
...
== AUBERON ~You have behaved no better than he has, <CHARNAME>, therefore, whatever punishment you see fitting to deal out to my son, you also deserve.~
...
== AUBERON ~He has brought dishonour to the name Duvaine, so it will be for him to find a way of restoring it.~
== AUBERON ~Govan, move!~
...
== AUBERON ~It has taken me a while to identify the murderer of my son, Govan, but I am a patient as well as a wealthy man <CHARNAME>.~
== AUBERON ~People will talk if the price is right. Did you seriously expect me not to uncover the truth?~
END
...
== AUBERON ~A plea of self defence may sit well with the courts, <CHARNAME>, but that is not the justice I want for my boy. I have had my say, now I will have my justice.~
