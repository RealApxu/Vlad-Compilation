...
== VPLEIP ~No, why should it be, you are devoid of compassion, that I can see. You are the same as he, <CHARNAME>.~ [leina_16]
DO ~SetGlobal("VP_Govan_Bribes_Me","GLOBAL",1) ActionOverride("Govan2",EscapeArea()) ActionOverride("GovDude",EscapeArea()) ActionOverride("GovBud",EscapeArea()) MoveGlobal("AR0086","vpleina",[300.300])~
EXIT
 //If PC goes to speak with Samuel Thunderburp then => Scenario: The Five Flagons 1
...
== VPLEIP ~Although it is obviously pride and revenge that brought you back here and not concern for my welfare.~ [leina_18]
== VPLEIP ~My freedom however, I still owe to you, so I will pay you the courtesy and say thank you.~ [leina_19]
END
...
== VPLEIP ~The Duvaines are very influential people, and it will not take them long to discover who is responsible for the death of the Duke and his family. Farewell.~ [leina_23]
...
== VPLEIP ~Hello, *DEAREST*, I guess you forgot to lock the door on your way out, *DARLING*!~ [leina_21]
== GOVAN3 ~What?!... Leina... Deare...~
EXTERN AUBERON 1
...
== VPLEIP ~We should talk to Samuel before news of this gets out, he will know what is to be done. I will make my way back to the tavern and talk to Samuel. I suggest you make haste and follow my lead.~ [leina_25]
DO ~SetGlobal("KickedOut","LOCALS",1) MoveGlobal("AR0509","vpleina",[365.374])~
EXIT
...
== VPLEIP ~I see now that I was foolish to allow the bad memories to overshadow the many good ones... memories that Samuel has talked about incessantly since I arrived here.~
== VPLEIP ~Now, if you are here to ask for my aid once again, I am ready to resume our journey.~
END
...
== FFBART ~You be sure you do lass. Now, you take care and be on your guard for that no good husband of yours. All smiles and pleasantries he was when he walked in here... but a face like thunder he had when he heard you'd left the city. He's trouble is that one, you mark my words lass.~
== VPLEIP ~Do not worry for me my friend. I half hope that Bjorn does find me, it's time to end this unhappy chapter in my life, erase him from it once and for all. New chapters are being written, even as we stand here...~
== VPLEIP ~Now, I must leave you again my friend, farewell... Come <CHARNAME>, let us make a start on those new chapters.~
...
== VPLEIP ~Still, I am more than happy to spend more time at The Five Flagons, and with Samuel. Please, I will be here if you find you should have need of me at some future time. Farewell and good luck to you...~
== VPLEIP ~(*As she turns away she picks up her lute*) Come Samuel, let us make some more joyful memories...~
