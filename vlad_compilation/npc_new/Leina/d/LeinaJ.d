...
//Working for Bodhi
//Third Path - State N4
IF WEIGHT #-6 ~Global("VP_ResqueLeina","GLOBAL",15) !Global("BodhiJob","GLOBAL",0)~ THEN BEGIN 4
...
IF ~~ THEN BEGIN 10
  ...
  IF ~~ THEN DO ~SetGlobal("VP_ResqueLeina","GLOBAL",17) ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) LeaveParty() MoveGlobal("AR0509","Leina",[313.437])~ EXIT
...
IF ~~ THEN BEGIN 28
  ...
  IF ~Global("BodhiJob","GLOBAL",0) Global("VP_Guild_Attacked","GLOBAL",1)~ THEN GOTO N29
END
...
IF WEIGHT #3 ~GlobalGT("VP_Enable_Flirts","LOCALS",0) GlobalLT("VP_Enable_Flirts","LOCALS",3) Global("VP_MyFlirt_Is_Over","LOCALS",0) !Global("VP_Leina_Samuel","GLOBAL",2) !Global("VP_Leina_Samuel","GLOBAL",4) !Global("VP_Leina_Samuel","GLOBAL",6) !Global("VP_InHalruaa","GLOBAL",1)~ THEN BEGIN 37
...
IF ~~ THEN BEGIN 64
  ...
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~TAFFICJ~ 28
END
...
IF ~~ THEN BEGIN 65
  ...
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~TAFFICJ~ leveler1
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~MELORAJ~ 25
...
IF ~~ THEN BEGIN 96
  ...
  IF ~~ THEN DO ~ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) LeaveParty() MoveGlobal("AR0509","Leina",[313.437])~ EXIT
END

IF WEIGHT #-2 ~Global("VP_Leina_Samuel","GLOBAL",4) Global("VP_Leina_In_City","LOCALS",1)~ THEN BEGIN 97
...
IF ~~ THEN BEGIN 100
  ...
  IF ~~ THEN DO ~ChangeAIScript("",DEFAULT) SetLeavePartyDialogFile() SetGlobal("KickedOut","LOCALS",1) SetGlobal("VP_Leina_Samuel","GLOBAL",7) LeaveParty() MoveGlobal("AR0509","Leina",[313.437])~ EXIT
END
...
IF WEIGHT #-4 ~Global("VP_Leina_Samuel","GLOBAL",4) Global("VP_Leina_Outside","LOCALS",1)~ THEN BEGIN 103
...
IF ~~ THEN BEGIN 110
  ...
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~MELORAJ~ 32
END
...
IF WEIGHT #4 ~GlobalGT("VP_Enable_Flirts","LOCALS",0) Global("VP_Enable_Flirts","LOCALS",4) GlobalLT("VP_LoveTalk","LOCALS",24) Global("VP_MyFlirt_Is_Over","LOCALS",0) !Global("VP_Leina_Samuel","GLOBAL",2) !Global("VP_Leina_Samuel","GLOBAL",4) !Global("VP_Leina_Samuel","GLOBAL",6) !Global("VP_InHalruaa","GLOBAL",1)~ THEN BEGIN 131
  SAY ~Yes... you need me for something?~
  ...
  IF ~!AreaType(CITY) OR(2) AreaType(OUTDOOR) AreaType(FOREST)~ THEN REPLY ~Leina how would you feel if we were forced to spend a little time in Athkatla again? I know you have bad memories of the place and were in a rush to leave, but I feel we have not yet seen the last of the city?~ GOTO LFlirts1101
  IF ~Global("VP_Flirt_Option_12","LOCALS",0) GlobalTimerExpired("VP_FlirtPoetry","GLOBAL")~ THEN REPLY ~Leina, would you please honour me with a tale to while away some time whilst it is quiet?~ GOTO LFlirts1201
...
IF ~~ THEN BEGIN LFlirts1204
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Flirt_Option_12","LOCALS",0) SetGlobalTimer("VP_FlirtPoetry","GLOBAL",ONE_DAY)~ EXIT
END
...
IF ~~ THEN BEGIN LFlirts1214
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Flirt_Option_12","LOCALS",0) SetGlobalTimer("VP_FlirtPoetry","GLOBAL",ONE_DAY) SetGlobal("VP_MyFlirt_Is_Over","LOCALS",1)~ EXIT
END
...
IF ~~ THEN BEGIN firattak
  ...
  IF ~InParty("Dar") !Dead("Dar")~ THEN EXTERN ~DARJ~ firattak
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~TAFFICJ~ firattak
END
...
IF ~~ THEN BEGIN firkdead9
  ...
  IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ THEN REPLY ~I am sorry Leina, I didn't mean to pry.~ GOTO firkdead7
  IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ THEN REPLY ~You were close to this teacher... I am sorry I didn't mean to open up old wounds forgive me.~ GOTO firkdead7
  IF ~OR(2) Gender(Player1,FEMALE) Global("VP_MyFlirt_Is_Over","LOCALS",1)~ THEN REPLY ~So these teachers of yours died before they could fill your head with more nonsense. Seems fate did you a favour.~ GOTO firkdead11
END
...
IF ~~ THEN BEGIN rayvon
  ...
  IF ~InParty("Kachiko") !Dead("Kachiko")~ THEN EXTERN ~KACHIJ~ NEJ60
...
IF ~~ THEN BEGIN immy8
  ...
  IF ~InParty("Hrothgar") !Dead("Hrothgar")~ THEN EXTERN ~IMOEN2~ hrothg1
  IF ~InParty("Taffic") !Dead("Taffic")~ THEN EXTERN ~TAFFICJ~ immy1
  IF ~InParty("Melora") !Dead("Melora")~ THEN EXTERN ~MELORAJ~ immy1
END
...
IF WEIGHT #5 ~GlobalGT("VP_Enable_Flirts","LOCALS",0) Global("VP_Enable_Flirts","LOCALS",4) GlobalGT("VP_LoveTalk","LOCALS",23) Global("VP_MyFlirt_Is_Over","LOCALS",0) !Global("VP_Leina_Samuel","GLOBAL",2) !Global("VP_Leina_Samuel","GLOBAL",4) !Global("VP_Leina_Samuel","GLOBAL",6) !Global("VP_InHalruaa","GLOBAL",1)~ THEN BEGIN NewFlirts
  SAY ~Yes... you need me for something?~
...
IF WEIGHT #6 ~GlobalGT("VP_Enable_Flirts","LOCALS",0) Global("VP_MyFlirt_Is_Over","LOCALS",0) !Global("VP_Leina_Samuel","GLOBAL",2) !Global("VP_Leina_Samuel","GLOBAL",4) !Global("VP_Leina_Samuel","GLOBAL",6) Global("VP_InHalruaa","GLOBAL",1)~ THEN BEGIN halruaaf
  SAY ~Yes... you need me for something?~
  ...
  IF ~InParty("Dar") !Dead("Dar") Global("VP_Flirt_Option_H3","LOCALS",0)~ THEN REPLY ~(*You whisper to Leina softly*) Keep your eye on Dar, Leina. If he trips on his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_H3","LOCALS",1)~ GOTO HF302
  IF ~InParty("Dar") !Dead("Dar") Global("VP_Flirt_Option_H3","LOCALS",1)~ THEN REPLY ~(*You whisper to Leina softly*) Keep your eye on Dar, Leina. If he trips on his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_H3","LOCALS",0)~ GOTO HF303
  IF ~Global("VP_Flirt_Option_31","LOCALS",0) OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",1)~ GOTO HF301
  IF ~Global("VP_Flirt_Option_31","LOCALS",1) OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",2)~ GOTO HF302
  IF ~Global("VP_Flirt_Option_31","LOCALS",2) OR(2) !InParty("Dar") Dead("Dar")~ THEN REPLY ~(*You whisper to Leina softly*) Keep your eye on Hrothgar, Leina. If he trips his robe once more, I swear he is going to fall flat on his face.~ DO ~SetGlobal("VP_Flirt_Option_31","LOCALS",3)~ GOTO HF303
...
IF ~~ THEN BEGIN inhell
  ...
  IF ~InParty("Kachiko") See("Kachiko")~ THEN EXTERN ~KACHIJ~ N55
END
...
//Third Path
//SetGlobal("VP_MyFatherIsDead","LOCALS",3)
IF WEIGHT #2 ~Global("VP_ResqueLeina","GLOBAL",15) Global("BodhiJob","GLOBAL",0) Global("VP_Guild_Attacked","GLOBAL",1) !Global("VP_MyFatherIsDead","LOCALS",3)~ THEN BEGIN N4
...
IF ~~ THEN BEGIN N30
  SAY ~This is too painful for me to face at this time, <CHARNAME>, for now, I do not wish to speak any further with you.~
  IF ~~ THEN DO ~SetGlobal("VP_ResqueLeina","GLOBAL",16) SetGlobal("VP_MyFatherIsDead","LOCALS",3)~ EXIT
END
