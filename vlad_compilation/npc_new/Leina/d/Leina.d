...
END
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~Forgive my manners Leina, I am <CHARNAME>. Samuel Thunderburp, the bartender of The Five Flagons was concerned for your safety and bid us to find you. Further answers will have to wait until we are safely out of here.~ EXTERN VPLEINA 2
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~I am called <CHARNAME>. We were promised a reward by the old barkeep of The Five Flagons if we found you safe. Well, we have found you and you seem to be unharmed so we guess we have earned our reward.~ EXTERN VPLEINA 2
...
END
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~You can thank me later, Leina, and I assure you, that you will have your answers, just not now. For the moment it is safer if you make your way to The Five Flagons. Samuel will be relieved to have you safely under his roof again.~ EXTERN VPLEINA 4
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~Thanks is all well and good, but my interest is in the reward. When you return to the tavern be sure to tell that old barkeep that I am close behind you.~ EXTERN VPLEINA 4
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",0)~ THEN REPLY ~You can thank me later, Leina, and I assure you, that you will have your answers, just not now. For the moment it is safer if we make our way out of here.~ EXTERN VPLEINA 4
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",0)~ THEN REPLY ~Thanks is all well and good, but we must hurry.~ EXTERN VPLEINA 4
...
END
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~You can thank me later, Leina, and I assure you, that you will have your answers, just not now. For the moment it is safer if you make your way to The Five Flagons. Samuel will be relieved to have you safely under his roof again.~ EXTERN VPLEINA 4
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",1)~ THEN REPLY ~Thanks is all well and good, but my interest is in the reward. When you return to the tavern be sure to tell that old barkeep that I am close behind you.~ EXTERN VPLEINA 4
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",0)~ THEN REPLY ~You can thank me later, Leina, and I assure you, that you will have your answers, just not now. For the moment it is safer if we make our way out of here.~ EXTERN VPLEINA 11
 IF ~Global("VP_Met_FFBarkeep","GLOBAL",0)~ THEN REPLY ~Thanks is all well and good, but we must hurry.~ EXTERN VPLEINA 11
...
CHAIN VPLEINA 5
~My only reason for doing so was the hope of a reconciliation with my father but my mother's death has changed him so, I am not even sure that I want a reconciliation with the man he has become.~ [leina_05]
EXTERN VPLEINA 6


CHAIN VPLEINA 6
~Nor do I wish to remain at The Five Flagons with the memories of the last few days keeping me from my sleep each night.~ [leina05a]
END
...
CHAIN VPLEINA 8
~I would feel much safer in your company if you have room for me in your group, but be it with you or be it alone, either way I will be taking to the road.~ [leina06a]
END
