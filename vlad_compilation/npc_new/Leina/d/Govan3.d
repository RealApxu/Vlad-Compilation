...
IF ~NumTimesTalkedTo(0) OR(2) GlobalGT("VP_Govan_Bribes_Me","GLOBAL",2) GlobalGT("VP_Killian_Bribes_Me","GLOBAL",1)~ THEN GOVAN3 0
~What... the... <CHARNAME>!~
END
 ++ ~Hello, Duvaine. Do shut your mouth, it is not a very dignified look.~ GOTO 1
 ++ ~Well, Duvaine, I half expected you to be gone. You must have a lot of confidence in your assassins abilities to risk staying here.~ GOTO 1
 ++ ~I hope you have not settled too well in here, Duvaine, looks like you will be on the move again. I have a more compact place in mind for you, shall we say about six foot by three foot!~ GOTO 1
 ++ ~Come, Duvaine, surely you did not think that I would miss your wedding? I was, after all, instrumental in bringing you and your future bride together.~ GOTO 1

CHAIN GOVAN3 1
~Now, <CHARNAME>, let us not be too hasty here. I made a mistake, a very foolish mistake, I can see that now.~
EXTERN GOVAN3 2

CHAIN GOVAN3 2
~You cannot blame a man for trying, it was after all, a lot of gold I was paying out, but I am good for it. Let me arrange to get it for you, no catches this time. I swear to you.~
END
...
CHAIN GOVAN3 3
~I just knew that you were not going to be reasonable about this, <CHARNAME>. I am not in the least bit intimidated by your threats.~
EXTERN GOVAN3 4

CHAIN GOVAN3 4
~I can assure you my guards here are better trained than a group of unruly assassins, let me demonstrate. Men...~
DO ~CreateCreatureObjectOffScreen("DuvGuard",Player1,0,0,0) CreateCreatureObjectOffScreen("DuvGuard",Player1,0,0,0) CreateCreatureObjectOffScreen("DuvGuard",Player1,0,0,0) Shout(89) Enemy()~ EXIT

CHAIN GOVAN3 5
~You need not concern yourself, father. I can handle this, a business venture gone wrong is that not right, <CHARNAME>?~
END
 ++ ~You are right there, Duvaine. How about you explain to your father just how wrong it did go?~ DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutL01")~ EXIT
 ++ ~The first truth to come out of that lying mouth of yours, Duvaine. You're going to tell your father the truth of the son he raised or shall I?~DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutL01")~ EXIT
 ++ ~So, Duvaine, playing happy families are we? Hold, someone is missing, now where is the blushing bride to be? Maybe your parents would like to hear how you courted and won her heart?~DO ~ClearAllActions() StartCutSceneMode() StartCutScene("VPCutL01")~ EXIT
